...
describe('countdown-tracker', () => {
  it('should render reset countdown tracker when a date in the past is given', async () => {
    const page = await newSpecPage({
      ...
      html: `<countdown-tracker data-initial-date="2024-11-05 13:24:00" data-target-date="2020-11-06 13:24:00"></countdown-tracker>`,
    });

    expect(page.root).toEqualHtml(`
    <countdown-tracker data-initial-date="2024-11-05 13:24:00" data-target-date="2020-11-06 13:24:00">
