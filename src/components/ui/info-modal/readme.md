...
| `modalDescription`    | `modal-description`     |             | `string`                        | `'Venha conferir nossa live cheia de novidades e promoções imperdíveis para você!'` |
...
| `on-click-primary-button`   |             | `CustomEvent<void>` |
| `on-click-secondary-button` |             | `CustomEvent<void>` |
