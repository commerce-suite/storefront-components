...
import { A as AppService } from './index2.js';
import { t as transformMediaUrl } from './utils.js';
import { d as defineCustomElement$2 } from './google-recaptcha2.js';
...
const MaintenanceMode$1 = /*@__PURE__*/ proxyCustomElement(class MaintenanceMode extends HTMLElement {
    ...
    static get style() { return MaintenanceModeStyle0; }
}, [0, "maintenance-mode", {
        "maintenanceModeData": [32],
        "maintenanceModeService": [32],
        "recaptchaToken": [32],
        "isLoading": [32],
        "isInitialLoading": [32],
        "userMessage": [32]
    }, [[0, "tokenReceived", "handleTokenReceived"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["maintenance-mode", "google-recaptcha"];
    components.forEach(tagName => { switch (tagName) {
        case "maintenance-mode":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MaintenanceMode$1);
            }
            break;
...
const MaintenanceMode = MaintenanceMode$1;
const defineCustomElement = defineCustomElement$1;

export { MaintenanceMode, defineCustomElement };
