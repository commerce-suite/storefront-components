import { proxyCustomElement, HTMLElement, createEvent, Env, h, Host } from '@stencil/core/internal/client';
import { a as ProductService, L as LiveShopService } from './index2.js';
import { e as extractYouTubeVideoId } from './utils.js';
import { d as defineCustomElement$h } from './color-selector2.js';
...
const LiveShop$1 = /*@__PURE__*/ proxyCustomElement(class LiveShop extends HTMLElement {
    ...
    static get style() { return liveShopCss; }
}, [0, "live-shop", {
...
function defineCustomElement$1() {
    ...
    const components = ["live-shop", "color-selector", "custom-card", "front-image", "highlight-card", "live-shop-desktop", "live-shop-mobile", "live-shop-not-found", "live-video-chat", "live-video-player", "product-card", "product-price", "product-price-billet", "product-price-credit-card", "product-price-pix", "product-price-simple", "tab-selector"];
