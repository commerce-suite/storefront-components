...
const LaunchMode$1 = /*@__PURE__*/ proxyCustomElement(class LaunchMode extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return LaunchModeStyle0; }
}, [0, "launch-mode", {
        "launchModeData": [32],
        "launchModeService": [32],
        "isLoading": [32],
        "isInitialLoading": [32],
        "userMessage": [32],
        "passwordInput": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["launch-mode"];
    components.forEach(tagName => { switch (tagName) {
        case "launch-mode":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LaunchMode$1);
            }
            break;
    } });
}

const LaunchMode = LaunchMode$1;
const defineCustomElement = defineCustomElement$1;

export { LaunchMode, defineCustomElement };
