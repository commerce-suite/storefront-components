...
const Showcase = /*@__PURE__*/ proxyCustomElement(class Showcase extends HTMLElement {
    ...
    render() {
        var _a;
        return (h(Host, { key: '98ef4a71d8c94ee6a6f1419041efa405d212c120' }, this.loading && (h("div", { key: 'a9e40658a4f22d3b244c8754c9c74ea0287243e0', class: "loading-container" }, h("span", { key: 'a68aff0b9f7be25675c8fd8e024971dc314da14b', class: "spinner" }))), !this.loading && this.products.length ? (h("div", { class: "showcase-related-products" }, h("h4", { class: "showcase-related-products-title" }, this.showcaseTitle || 'Recomendados para você'), h("div", { class: "splide-container" }, h("div", { id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, h("div", { class: "splide__track" }, h("ul", { class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
