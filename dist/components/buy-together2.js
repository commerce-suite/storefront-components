...
import { d as defineCustomElement$8 } from './front-select2.js';
...
const BuyTogether = /*@__PURE__*/ proxyCustomElement(class BuyTogether extends HTMLElement {
    ...
    static get style() { return buyTogetherCss; }
}, [2, "buy-together", {
...
function defineCustomElement() {
    ...
    const components = ["buy-together", "front-image", "front-select", "product-card", "product-price", "product-price-billet", "product-price-credit-card", "product-price-pix", "product-price-simple", "variation-selector"];
