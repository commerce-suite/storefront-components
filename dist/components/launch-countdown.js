...
const LaunchCountdown$1 = /*@__PURE__*/ proxyCustomElement(class LaunchCountdown extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return LaunchCountdownStyle0; }
}, [0, "launch-countdown", {
        "productId": [1025, "product-id"],
        "variationId": [1025, "variation-id"],
        "dataTargetDate": [1, "data-target-date"],
        "dataInitialDate": [1, "data-initial-date"],
        "dataCountdownTitle": [1, "data-countdown-title"],
        "dataDescription": [1, "data-description"],
        "dateTime": [32]
    }, undefined, {
        "variationId": ["watchVariationIdChange"],
        "productId": ["watchProductIdChange"]
...
function defineCustomElement$1() {
    ...
    const components = ["launch-countdown", "front-countdown"];
    components.forEach(tagName => { switch (tagName) {
        case "launch-countdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, LaunchCountdown$1);
            }
            break;
...
const LaunchCountdown = LaunchCountdown$1;
const defineCustomElement = defineCustomElement$1;

export { LaunchCountdown, defineCustomElement };
