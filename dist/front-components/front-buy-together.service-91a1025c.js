import { c as commonjsGlobal, B as BuyTogetherService } from './index-a6a2a63f.js';
...
class FrontBuyTogetherAdapter {
    ...
    static generateSelectAttributes(product) {
        ...
        if (product.name === 'Produto só com atributo e secundário')
            console.log(product);
    ...
    static resetAttributes(product) {
        console.log('🚀 ~ FrontBuyTogetherAdapter ~ resetAttributes ~ product:', product);
        return product;
    }
    ...
    static filterAttributesByUnique(attributesGeneric, attributeTarget) {
        return attributesGeneric
            ...
            // if (current.name === 'Tênis Vans old skool' && attributeTarget === 'color')
            //   console.log('🚀 ~ FrontBuyTogetherAdapter ~ objItem:', objItem);
...
//# sourceMappingURL=front-buy-together.service-91a1025c.js.map