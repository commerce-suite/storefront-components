...
describe('product-card', () => {
    it('should render without payment options', async () => {
        const page = await newSpecPage({
            ...
            template: () => (h("product-price", { basePrice: { price: 999.99, priceCompare: 1299.99 } })),
        });
    ...
    it('should render with options', async () => {
        const page = await newSpecPage({
            components: [ProductPrice],
            template: () => (h("product-price", { paymentOptions: [
                    {
                        type: 'creditCard',
                        price: 999.99,
    ...
    it('should render with only pix', async () => {
        const page = await newSpecPage({
            components: [ProductPrice],
            template: () => (h("product-price", { paymentOptions: [{ type: 'pix', price: 999.99, priceCompare: 1199.99 }] })),
        });
        expect(page.root).toEqualHtml(`
      <product-price>
        <div class="product-price-container">
    ...
    it('should render with only billet', async () => {
        const page = await newSpecPage({
            components: [ProductPrice],
            template: () => (h("product-price", { paymentOptions: [{ type: 'billet', price: 999.99, priceCompare: 1199.99 }] })),
        });
        expect(page.root).toEqualHtml(`
      <product-price>
        <div class="product-price-container">
    ...
    it('should render with only simple', async () => {
        const page = await newSpecPage({
            components: [ProductPrice],
            template: () => (h("product-price", { paymentOptions: [{ type: 'simple', price: 999.99, priceCompare: 1199.99 }] })),
        });
        expect(page.root).toEqualHtml(`
      <product-price>
        <div class="product-price-container">
...
//# sourceMappingURL=product-price.spec.js.map
