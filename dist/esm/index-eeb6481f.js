...
const Env = /* front-components */ {"WEBSOCKET_URL":"wss://socket-liveshop.dchomolog.dooca.store/","GOOGLE_RECAPTCHA_SITE_KEY":"6Ldm_6cZAAAAAHbNTBa7Nux52Zb7S0LuMknhKdQH","CDN_URL":"https://cdn.dooca.store"};
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'front-icon_3':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-icon_3.entry.js').then(processMod, consoleError);
                ...
                case 'live-shop-desktop_3':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-shop-desktop_3.entry.js').then(processMod, consoleError);
                case 'highlight-card_3':
                    return import(
                      /* webpackMode: "lazy" */
                      './highlight-card_3.entry.js').then(processMod, consoleError);
                case 'front-select_2':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-select_2.entry.js').then(processMod, consoleError);
                case 'color-selector_2':
                    return import(
                      /* webpackMode: "lazy" */
                      './color-selector_2.entry.js').then(processMod, consoleError);
                case 'front-image_7':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-image_7.entry.js').then(processMod, consoleError);
          }
      }
  return import(
    /* @vite-ignore */
...
export { Env as E, Fragment as F, Host as H, getElement as a, bootstrapLazy as b, createEvent as c, getAssetPath as g, h, promiseResolve as p, registerInstance as r, setNonce as s };

//# sourceMappingURL=index-eeb6481f.js.map