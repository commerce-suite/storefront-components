        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'cashback-credit':
                    return import(
                      /* webpackMode: "lazy" */
                      './cashback-credit.entry.js').then(processMod, consoleError);
                case 'info-modal':
                    return import(
                      /* webpackMode: "lazy" */
                ...
                case 'live-shop':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-shop.entry.js').then(processMod, consoleError);
                case 'maintenance-mode':
                    return import(
                      /* webpackMode: "lazy" */
                      './maintenance-mode.entry.js').then(processMod, consoleError);
                case 'mini-player':
                    return import(
                      /* webpackMode: "lazy" */
                ...
                case 'front-icon':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-icon.entry.js').then(processMod, consoleError);
                case 'google-recaptcha':
                    return import(
                      /* webpackMode: "lazy" */
                      './google-recaptcha.entry.js').then(processMod, consoleError);
                case 'live-shop-desktop':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-shop-desktop.entry.js').then(processMod, consoleError);
                case 'live-shop-mobile':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-shop-mobile.entry.js').then(processMod, consoleError);
                case 'live-shop-not-found':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-shop-not-found.entry.js').then(processMod, consoleError);
                case 'tab-selector':
                    return import(
                      /* webpackMode: "lazy" */
                      './tab-selector.entry.js').then(processMod, consoleError);
                case 'variation-selector':
                    return import(
                      /* webpackMode: "lazy" */
                      './variation-selector.entry.js').then(processMod, consoleError);
                case 'front-select':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-select.entry.js').then(processMod, consoleError);
                case 'highlight-card':
                    return import(
                      /* webpackMode: "lazy" */
                      './highlight-card.entry.js').then(processMod, consoleError);
                case 'live-video-chat':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-video-chat.entry.js').then(processMod, consoleError);
                case 'color-selector':
                    return import(
                      /* webpackMode: "lazy" */
                      './color-selector.entry.js').then(processMod, consoleError);
                case 'custom-card':
                    return import(
                      /* webpackMode: "lazy" */
                      './custom-card.entry.js').then(processMod, consoleError);
                case 'live-video-player':
                    return import(
                      /* webpackMode: "lazy" */
                      './live-video-player.entry.js').then(processMod, consoleError);
                case 'product-card':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-card.entry.js').then(processMod, consoleError);
                case 'front-image':
                    return import(
                      /* webpackMode: "lazy" */
                      './front-image.entry.js').then(processMod, consoleError);
                case 'product-price':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-price.entry.js').then(processMod, consoleError);
                case 'product-price-billet':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-price-billet.entry.js').then(processMod, consoleError);
                case 'product-price-credit-card':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-price-credit-card.entry.js').then(processMod, consoleError);
                case 'product-price-pix':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-price-pix.entry.js').then(processMod, consoleError);
                case 'product-price-simple':
                    return import(
                      /* webpackMode: "lazy" */
                      './product-price-simple.entry.js').then(processMod, consoleError);
          }
      }
  return import(
    /* @vite-ignore */
...
export { BUILD as B, Env as E, Fragment as F, H, NAMESPACE as N, createEvent as a, bootstrapLazy as b, consoleDevInfo as c, doc as d, Host as e, getElement as f, getAssetPath as g, h, promiseResolve as p, registerInstance as r, setNonce as s };

//# sourceMappingURL=index-9b51ba9f.js.map