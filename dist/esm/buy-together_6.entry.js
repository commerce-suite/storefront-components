...
import { B as BuyTogetherService } from './index-fb716be7.js';
...
const BuyTogether = class {
    ...
    render() {
        return (h(Host, { key: 'e93bb257d558b5dd86624588b46249f088e4795c' }, this.isLoading && (h("div", { key: '38c1a4fa630b8ab84dcfccdeacd01217e5da003b', class: "loading-container" }, h("span", { key: '16bdf5fb7300be173a6330d39e3fdda065a54f89', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (h("form", { key: '21792f53904673fa824a912f5dc7a3e81156a42f', onSubmit: evt => this.onAddItemsToCart(evt) }, h("div", { key: 'a239669b9857ff857252beffc076eda548fd8354', class: "title-wrapper" }, h("h2", { key: '919657904f77f2a040f2a34885c8f6e554a0ea70', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), h("section", { key: 'b2a5b9ccbd22044228f83ce216f86e75ed234c8c', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (h("div", { key: '3a42ed646eef6f59cf3bde40d3a452c6e3406fb7', class: "product-main" }, h("div", { key: '2cb95cc72c4e796d4b7fc1d9652a574fc229cf4b', class: "product-wrapper" }, h("product-card", { key: '4cfa348f1b88ea19ca5ddd43a07b7d308ead7218', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (h("variation-selector", { key: '83187587ba4c149f167e8f563df85484e98a2061', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (h("div", { key: '5fe57ab76e6d319d92f902ad3bf6a9dd91ba0641', class: "plus-icon" }, h("img", { key: '26d4ef9573d82aef5ec45d2b6705fa2a32791cf6', src: getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), h("div", { key: 'ed4f1bf108b38dd7f3dd946ef58a6a1c89af0209', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (h("div", { class: "product-wrapper" }, h("div", { class: "product-wrapper-pivot" }, h("div", { class: "checkbox-wrapper" }, h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), h("div", { key: '5e6aeae4fde35b8179ad5cabd4918159c226b914', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, h("button", { key: '45fae88bd6eabf13695400a6d82f28e0af7cb511', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const Showcase = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.clickBuyButton = createEvent(this, "clickBuyButton", 7);
    ...
    render() {
        var _a;
        return (h(Host, { key: '9af997fe51eae247dff58b4c3e7fe860f6a505df' }, this.loading && (h("div", { key: '545128fd50c4d99922691decfd0a294ad932f795', class: "loading-container" }, h("span", { key: 'cdf333a124e87b60159e8dd7476ab2011db0772a', class: "spinner" }))), !this.loading && this.products.length ? (h("div", { class: "showcase-related-products" }, h("h4", { class: "showcase-related-products-title" }, this.showcaseTitle || 'Recomendados para você'), h("div", { id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, h("div", { class: "splide__track" }, h("ul", { class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
...
export { BuyTogether as buy_together, FrontImage as front_image, FrontSelect as front_select, ProductCard as product_card, Showcase as showcase_related, VariationSelector as variation_selector };

//# sourceMappingURL=buy-together_6.entry.js.map