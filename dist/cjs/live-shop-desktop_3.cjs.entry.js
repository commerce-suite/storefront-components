...
const LiveShopDesktop = class {
    ...
    render() {
        return (index.h("div", { key: '7effd5e5056878188a22174117cac9f59a104448', class: "live-shop-in-live-desktop" }, index.h("div", { key: 'b0e522dbd996132ea436f68cc189c873bd32b426', class: "live-shop-in-live-desktop-infos" }, index.h("div", { key: '513680509fadb268cbd12b928b2425e6492bd147', class: "live-shop-in-live-desktop-infos-player" }, index.h("live-video-player", { key: 'f95b5d568a0b8f3390730d0b011c53f40d72c2a4', videoId: this.videoId, autoPlay: true })), index.h("div", { key: '1bf91d44a1dff664f95d4fb5a6a8aa29b73f433c', class: "live-shop-in-live-desktop-infos-options" }, index.h("h2", { key: '9c875b4d7ccdeb8e0e0e5da3b6f47426e55cb597', class: "live-shop-in-live-desktop-infos-options-title" }, this.liveShopData.name), this.liveShopData.chatVisible && (index.h("button", { key: '0b98a66253a410bbe19dae59f7d341a3b6b09b09', class: "live-shop-in-live-desktop-infos-options-button", onClick: this.toggleChat }, this.buttonText()))), this.isChatOpen && (index.h("div", { key: '809f4e26270e749a19f69a7a524649595acfc8d6', class: "live-shop-in-live-desktop-infos-options-chat" }, index.h("live-video-chat", { key: '99755ba8e3ba5eb43e06088f61c2e71ae2c95e44', videoId: this.videoId })))), index.h("div", { key: 'bd2fcf81a3785dea7f113e4e16e9f04d6b580831', class: "live-shop-in-live-desktop-content" }, index.h("div", { key: '12285340c2df6121142e6c72c7e9c17a7d56930b', class: "live-shop-in-live-desktop-content-card" }, this.items.length > 0 && this.items.some(item => item.show) ? (index.h("highlight-card", { items: this.items, onAddItem: this.handleAddItem })) : (index.h("custom-card", { customClass: "in-live-custom-style-desktop", cardTitle: "produtos a caminho...", cardDescription: "Em breve, teremos algo especial para voc\u00EA!" }))))));
    }
};
...
const LiveShopMobile = class {
    ...
    render() {
        return (index.h("div", { key: '528b7782f3fc5040d256fac4299312951aa7e5c1', class: "live-shop-in-live" }, index.h("div", { key: '7820bb481374988eb8de510c4669eb93ad2e406f', class: "live-shop-in-live-player" }, index.h("live-video-player", { key: '11970b8e9cfaa389ee865dc040c57781d5d9ea26', videoId: this.videoId, autoPlay: true })), index.h("div", { key: '4bc610f7be52f321e8644f498044cd33a40e39db', class: "live-shop-in-live-options" }, index.h("custom-card", { key: 'b878361726fb04c08624c3936cfd2d497251c628', customClass: "in-live-custom-style", cardTitle: this.liveShopData.name }, index.h("tab-selector", { key: 'e51ec56e35e9c0b38e821ff5067dfa5c17e0c7c2', tabs: tabs(this.videoId, this.items, this.handleAddItem, this.liveShopData.chatVisible) })))));
    }
};
...
const LiveShopNotFound = class {
    ...
    render() {
        return (index.h(index.Host, { key: '13d445804b733489f04429561582f5e743a0aa0c' }, index.h("div", { key: '8a1ed75b26be912fc7c4d6161bc29d4bdc5937ca', class: "live-shop-not-found" }, index.h("custom-card", { key: '7a545796f0627a13f5a46827df9311cc24b059a8', cardTitle: "Ops, parece que essa live n\u00E3o existe mais!", cardDescription: "Fique de olho em nossas pr\u00F3ximas lives para mais novidades!" }, index.h("button", { key: 'd435e382e9a704356e28087672015eeedd710a7e', onClick: this.handleReturnToHome }, "Voltar para a p\u00E1gina inicial")))));
    }
};
...
//# sourceMappingURL=live-shop-desktop_3.cjs.entry.js.map