...
const BUILD = /* front-components */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: true, cssAnnotations: true, devTools: false, disconnectedCallback: true, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: true, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: true, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: true, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: false, scoped: true, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: false, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: true, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: true };
const Env = /* front-components */ {};

/*!
 Stencil Mock Doc v4.17.0 | MIT Licensed | https://stenciljs.com
 */

// src/runtime/runtime-constants.ts
var CONTENT_REF_ID$1 = "r";
var ORG_LOCATION_ID$1 = "o";
var SLOT_NODE_ID$1 = "s";
var TEXT_NODE_ID$1 = "t";
...
function getNamespaceURI(namespaceURI) {
  return namespaceURI === XLINK_NS$1 ? null : namespaceURI;
}
...
function fireConnectedCallback$1(node) {
  ...
  if (node.nodeType === 1 /* ELEMENT_NODE */ || isShadowRoot) {
    ...
    if (ignoreTag === false) {
      ...
      for (let i = 0; i < attrsLength; i++) {
        ...
        } else if (attrNamespaceURI === XLINK_NS$1) {
...
style="${cssText}">`);
    ...
    if (opts.removeHtmlComments) {
      const isHydrateAnnotation = (nodeValue == null ? void 0 : nodeValue.startsWith(CONTENT_REF_ID$1 + ".")) || (nodeValue == null ? void 0 : nodeValue.startsWith(ORG_LOCATION_ID$1 + ".")) || (nodeValue == null ? void 0 : nodeValue.startsWith(SLOT_NODE_ID$1 + ".")) || (nodeValue == null ? void 0 : nodeValue.startsWith(TEXT_NODE_ID$1 + "."));
    ...
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
          style = await Promise.resolve().then(function () { return require('./shadow-css-e85c65f9.js'); }).then((m) => m.scopeCss(style, scopeId2, false));
        }
    ...
    return module[exportName];
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'cashback-credit.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './cashback-credit.cjs.entry.js')); }).then(processMod, consoleError);
                case 'info-modal.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                ...
                case 'launch-mode.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './launch-mode.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-shop.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                ...
                case 'front-icon.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './front-icon.cjs.entry.js')); }).then(processMod, consoleError);
                case 'google-recaptcha.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './google-recaptcha.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-shop-desktop.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './live-shop-desktop.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-shop-mobile.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './live-shop-mobile.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-shop-not-found.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './live-shop-not-found.cjs.entry.js')); }).then(processMod, consoleError);
                case 'tab-selector.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './tab-selector.cjs.entry.js')); }).then(processMod, consoleError);
                case 'variation-selector.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './variation-selector.cjs.entry.js')); }).then(processMod, consoleError);
                case 'front-select.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './front-select.cjs.entry.js')); }).then(processMod, consoleError);
                case 'highlight-card.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './highlight-card.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-video-chat.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './live-video-chat.cjs.entry.js')); }).then(processMod, consoleError);
                case 'color-selector.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './color-selector.cjs.entry.js')); }).then(processMod, consoleError);
                case 'custom-card.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './custom-card.cjs.entry.js')); }).then(processMod, consoleError);
                case 'live-video-player.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './live-video-player.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-card.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-card.cjs.entry.js')); }).then(processMod, consoleError);
                case 'front-image.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './front-image.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-price.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-price.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-price-billet.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-price-billet.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-price-credit-card.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-price-credit-card.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-price-pix.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-price-pix.cjs.entry.js')); }).then(processMod, consoleError);
                case 'product-price-simple.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './product-price-simple.cjs.entry.js')); }).then(processMod, consoleError);
          }
      }
  return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
    /* @vite-ignore */
...
//# sourceMappingURL=index-ccb6baf7.js.map