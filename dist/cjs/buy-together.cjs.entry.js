...
const BuyTogether = class {
    ...
    render() {
        return (index.h(index.Host, { key: '50d0577a7bae71964d87c0fba49add6027bdc1f9' }, this.isLoading && (index.h("div", { key: 'ea2bb5013e6ed9f7c099288b7ef459c542ebc00b', class: "loading-container" }, index.h("span", { key: 'fd5b91847f76da5ebda1a4933aea65c5e3783e2f', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index.h("form", { key: 'af8349bed74fb8c7bba35089ccc1cc66584ba9eb', onSubmit: evt => this.onAddItemsToCart(evt) }, index.h("div", { key: '2822538a4a0d28fced907e94c0c23b7ac1684439', class: "title-wrapper" }, index.h("h2", { key: 'd6b8c3e81a7a31fde0f20dc65f47a68d530301f9', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), index.h("section", { key: '24ff30029ceb36fd66f705827ea5cd17fbc19460', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index.h("div", { key: '69681b0b617cfb65dbe04beeae7f87bf8f63cae1', class: "product-main" }, index.h("div", { key: '85d34d30c3c6b1ee53f5d000ec222cffadc19819', class: "product-wrapper" }, index.h("product-card", { key: '74c3143d77db36527669a85b7d1f8530c5f0ca67', product: this.buyTogetherData.productMain, paymentOptions: this.buyTogetherData.productMain.paymentOptions }), this.buyTogetherData.productMain.selectVariations && (index.h("variation-selector", { key: '266bdf9a13b2286efe046b02780af8ac66bedb59', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index.h("div", { key: '47ba67f467c95d11ab27e8bd26c882a2cde5e093', class: "plus-icon" }, index.h("img", { key: 'aedda567295263226b32cc14da035f2e0202aa26', src: index.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index.h("div", { key: '7f9bfff55456a61c8d4d3ac063c637dfd2ec74ca', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index.h("div", { class: "product-wrapper" }, index.h("div", { class: "product-wrapper-pivot" }, index.h("div", { class: "checkbox-wrapper" }, index.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index.h("product-card", { inline: true, product: productCard, paymentOptions: productCard.paymentOptions })), productCard.selectVariations && (index.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index.h("div", { key: 'a78d4903e53653446acc8ebd5f74de5de6b39b43', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index.h("button", { key: '4ed9fcb85eae4641d8ad2b99ab8bab305e0a6124', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
BuyTogether.style = buyTogetherCss;
