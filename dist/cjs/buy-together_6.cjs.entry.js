...
const index = require('./index-d5bf4739.js');
...
const BuyTogether = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '93de54f3d47e55344b1c319f66d552109900b87c' }, this.isLoading && (index$1.h("div", { key: '152b81303b6d7dc6d4cfcf2ca594bc445d5187ce', class: "loading-container" }, index$1.h("span", { key: 'f4df8a2de0d0ec317f8224c17c3d2619789153a5', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index$1.h("form", { key: '116d75cc4d2d4178338dc98012226c84706fdc02', onSubmit: evt => this.onAddItemsToCart(evt) }, index$1.h("div", { key: 'c476c95b55dce366e11bc582a0ef55f6c6b0bbcf', class: "title-wrapper" }, index$1.h("h2", { key: '4ba05a4f439bbd5212cee385f0a062e022c7b745', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), index$1.h("section", { key: 'ea078d6f630c4ba549751237057efadcc91a348e', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index$1.h("div", { key: 'd4bd9faf3c73edc65451e3f581ba7149332d9d1f', class: "product-main" }, index$1.h("div", { key: 'd1ddce1d52c6cbdc4bdf975fc33dc030e7936b18', class: "product-wrapper" }, index$1.h("product-card", { key: '7ea0889425bceaf9796d0bb8505bf1ebd7ad3fc0', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index$1.h("variation-selector", { key: '7f40f1b860c25909381523f489da9b8b28fda954', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index$1.h("div", { key: 'c246d8367ff06879b7e866632a4f69480e16cd42', class: "plus-icon" }, index$1.h("img", { key: '3544eec39014e2ee4c6057b7a9fa8e6a2ce8c3e0', src: index$1.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index$1.h("div", { key: 'b9c9921f9ab70cca9088584e24dcfbf1bd1be8f6', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index$1.h("div", { class: "product-wrapper" }, index$1.h("div", { class: "product-wrapper-pivot" }, index$1.h("div", { class: "checkbox-wrapper" }, index$1.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index$1.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index$1.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index$1.h("div", { key: 'd28dcad1d0fd80a63db4cad6fc82f4b639e8bb28', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index$1.h("button", { key: '60e014443f987b4125a1b4c77717937b00034500', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const ProductCard = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index$1.h(index$1.Host, { key: '858f40d36381339ac56cdf361862d99570b60827' }, index$1.h("div", { key: '69f7e6fbb44421c31f75dc39c575177d0ce0847f', class: this.getClassWithInline('product-container') }, index$1.h("front-image", { key: '29ac89fa414116489d0f6db0e69f659a2d6c77d8', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index$1.h("div", { key: '81cbcea072e99824c8b5b4fa120f89a152bed748', class: "info" }, index$1.h("span", { key: 'abc07c3b23b66998220a61ec4988b473eb303969', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index$1.h("div", { key: 'd71bd4db5dadaec4fd7151005b3dd7a25543b74e', class: "price" }, this.showPriceBase && (index$1.h("span", { key: '964270e9cad98f70c5a91015d0beaac51add0cc5', class: "base" }, currencyFormat(this.product.priceBase))), index$1.h("span", { key: '8966cccd3376d73766432131b02a1bdfc6a9acb8', class: "current" }, this.getPrice()))))));
    }
};
...
const Showcase = class {
    ...
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: '9d0be3f8ce8c1c3a8bb5b5379df706de8e884ef7' }, this.loading && (index$1.h("div", { key: 'b72a7f04f6f6384a245fc34b602c8d925ba5703c', class: "loading-container" }, index$1.h("span", { key: '9bc137bad811143e66fbd500719b942845b7f36a', class: "spinner" }))), !this.loading && this.products.length ? (index$1.h("div", { class: "showcase-related-products" }, index$1.h("h4", { class: "showcase-related-products-title" }, this.showcaseTitle || 'Recomendados para você'), index$1.h("div", { id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, index$1.h("div", { class: "splide__track" }, index$1.h("ul", { class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
...
const VariationSelector = class {
    ...
    render() {
        return (index$1.h("div", { key: '6aef58ac81d122d000a07639b330f4edcc004d3a', class: `variations ${this.showcaseMode ? '-showcase' : ''}` }, this.variations.map(({ label, currentValue, options, selectId, placeholder, selectType }) => (index$1.h("div", { class: "item" }, index$1.h("front-select", { placeholder: placeholder, selectId: selectId, optionsList: options, label: label, value: currentValue, onInput: data => this.onInputSelect(data, selectType) }))))));
    }
};
...
//# sourceMappingURL=buy-together_6.cjs.entry.js.map