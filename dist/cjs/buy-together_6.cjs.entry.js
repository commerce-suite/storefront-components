...
const BuyTogether = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '4fe9c5b3bc3742496368fd85696b413adbc4d923' }, this.isLoading && (index$1.h("div", { key: '878573489e436b8b458e88a212b57f3b31e21688', class: "loading-container" }, index$1.h("span", { key: 'c9e2aa6cdf13e682e3697a926ef9f877b50cf55d', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index$1.h("form", { key: 'a159fc3985ec7499c29cb61f06b6d20eecc29dd4', onSubmit: evt => this.onAddItemsToCart(evt) }, index$1.h("div", { key: '34a1da57becce9107c9c962405a452cd702b2b9b', class: "title-wrapper" }, index$1.h("h2", { key: '71ca991067a8f3d50e34d3670bd9b2a5675db196', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), index$1.h("section", { key: '0d8b9e0f0d61121102a038f99e99b8b2f3083583', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index$1.h("div", { key: '1a37ba95365994495bb84baad9bff698ae914c72', class: "product-main" }, index$1.h("div", { key: 'fcadda1ca0ac48075630a1cf97eab88034b405a2', class: "product-wrapper" }, index$1.h("product-card", { key: 'e29ca7096f2f8ae043d341250e82ed4f886ca060', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index$1.h("variation-selector", { key: '89593ce78b4e4f39561a486eb71ce6f83e6364c5', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index$1.h("div", { key: '386a17b1f53e69bdd8536b0c36a3a15a3fb7cb89', class: "plus-icon" }, index$1.h("img", { key: 'b4a5fe51a706abbcd46a1cbeda0dc3315c44bb5f', src: index$1.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index$1.h("div", { key: '483a7172937e86f32529bb84e52f482609e017cd', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index$1.h("div", { class: "product-wrapper" }, index$1.h("div", { class: "product-wrapper-pivot" }, index$1.h("div", { class: "checkbox-wrapper" }, index$1.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index$1.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index$1.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index$1.h("div", { key: '0cac8431e61385a69eb3bb6a975e3292d66f8208', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index$1.h("button", { key: '688598aa73e222854a721a90e5e298d1b149e857', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
