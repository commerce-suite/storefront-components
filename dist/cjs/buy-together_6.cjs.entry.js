...
const index$1 = require('./index-adfef3ec.js');
...
const Showcase = class {
    ...
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: '817ff01a3fb6907182cf50300a67b37f5782a173' }, this.loading && (index$1.h("div", { key: 'fcb850c8891b756fd79894869c7fedf2eefbffb8', class: "loading-container" }, index$1.h("span", { key: '0081fe6adbcab2834a7742b16d43660b444fa20b', class: "spinner" }))), !this.loading && this.products.length ? (index$1.h("div", { class: "showcase-related-products" }, index$1.h("h4", { class: "showcase-related-products-title" }, this.showcaseTitle || 'Recomendados para você'), index$1.h("div", { id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, index$1.h("div", { class: "splide__track" }, index$1.h("ul", { class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
