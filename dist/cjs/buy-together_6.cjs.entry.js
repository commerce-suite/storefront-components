...
const BuyTogether = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'e93bb257d558b5dd86624588b46249f088e4795c' }, this.isLoading && (index$1.h("div", { key: '38c1a4fa630b8ab84dcfccdeacd01217e5da003b', class: "loading-container" }, index$1.h("span", { key: '16bdf5fb7300be173a6330d39e3fdda065a54f89', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index$1.h("form", { key: '21792f53904673fa824a912f5dc7a3e81156a42f', onSubmit: evt => this.onAddItemsToCart(evt) }, index$1.h("div", { key: 'a239669b9857ff857252beffc076eda548fd8354', class: "title-wrapper" }, index$1.h("h2", { key: '919657904f77f2a040f2a34885c8f6e554a0ea70', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), index$1.h("section", { key: 'b2a5b9ccbd22044228f83ce216f86e75ed234c8c', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index$1.h("div", { key: '3a42ed646eef6f59cf3bde40d3a452c6e3406fb7', class: "product-main" }, index$1.h("div", { key: '2cb95cc72c4e796d4b7fc1d9652a574fc229cf4b', class: "product-wrapper" }, index$1.h("product-card", { key: '4cfa348f1b88ea19ca5ddd43a07b7d308ead7218', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index$1.h("variation-selector", { key: '83187587ba4c149f167e8f563df85484e98a2061', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index$1.h("div", { key: '5fe57ab76e6d319d92f902ad3bf6a9dd91ba0641', class: "plus-icon" }, index$1.h("img", { key: '26d4ef9573d82aef5ec45d2b6705fa2a32791cf6', src: index$1.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index$1.h("div", { key: 'ed4f1bf108b38dd7f3dd946ef58a6a1c89af0209', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index$1.h("div", { class: "product-wrapper" }, index$1.h("div", { class: "product-wrapper-pivot" }, index$1.h("div", { class: "checkbox-wrapper" }, index$1.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index$1.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index$1.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index$1.h("div", { key: '5e6aeae4fde35b8179ad5cabd4918159c226b914', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index$1.h("button", { key: '45fae88bd6eabf13695400a6d82f28e0af7cb511', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const ProductCard = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index$1.h(index$1.Host, { key: '3186b4f9bbc34d64d26b0bf9aa50667cdb1923a4' }, index$1.h("div", { key: 'a5ea8e400feb43638a7155576dab2b1d0d3e2a7d', class: this.getClassWithInline('product-container') }, index$1.h("front-image", { key: 'fa7c2e423e2a25773366144198cea804981fc185', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index$1.h("div", { key: 'ef49c018c82a0b19a0a11d8cf54c65c077e22e74', class: "info" }, index$1.h("span", { key: 'f2e36d52bc00d9e1a0493310f4c4d10c4e11ab5f', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index$1.h("div", { key: '324a9c7efb0968b7ccd9133416bec8757ac606ec', class: "price" }, this.showPriceBase && (index$1.h("span", { key: '68a1f75bdfecbad9849d0970756ac404c216ae48', class: "base" }, currencyFormat(this.product.priceBase))), index$1.h("span", { key: '8a16a384372a6597d75f055931276f3956ab1330', class: "current" }, this.getPrice()))))));
    }
};
