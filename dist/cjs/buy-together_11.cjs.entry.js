...
const index = require('./index-512e84ed.js');
...
class FrontBuyTogetherService {
    ...
    async getBuyTogetherAppContent() {
        try {
            const response = await index.AppService.getBySlug('buy-together');
...
const BuyTogether = class {
    constructor(hostRef) {
        ...
        this.onBuyTogetherAddCartEvent = index$1.createEvent(this, "on-buy-together-add-cart", 7);
        this.loadBuyTogehter = index$1.createEvent(this, "loadBuyTogehter", 7);
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'e93bb257d558b5dd86624588b46249f088e4795c' }, this.isLoading && (index$1.h("div", { key: '38c1a4fa630b8ab84dcfccdeacd01217e5da003b', class: "loading-container" }, index$1.h("span", { key: '16bdf5fb7300be173a6330d39e3fdda065a54f89', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index$1.h("form", { key: '21792f53904673fa824a912f5dc7a3e81156a42f', onSubmit: evt => this.onAddItemsToCart(evt) }, index$1.h("div", { key: 'a239669b9857ff857252beffc076eda548fd8354', class: "title-wrapper" }, index$1.h("h2", { key: '919657904f77f2a040f2a34885c8f6e554a0ea70', class: `title ${this.showcaseModeClass()}` }, this.promotionTitle || 'Compre Junto')), index$1.h("section", { key: 'b2a5b9ccbd22044228f83ce216f86e75ed234c8c', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index$1.h("div", { key: '3a42ed646eef6f59cf3bde40d3a452c6e3406fb7', class: "product-main" }, index$1.h("div", { key: '2cb95cc72c4e796d4b7fc1d9652a574fc229cf4b', class: "product-wrapper" }, index$1.h("product-card", { key: '73fb1f4a765258edb8235e7d4c07be14f4f7bfd2', product: this.buyTogetherData.productMain, paymentOptions: this.buyTogetherData.productMain.paymentOptions }), this.buyTogetherData.productMain.selectVariations && (index$1.h("variation-selector", { key: 'cdee4a1b28f10d993f66fe5e2e0ab98ff9c7325c', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index$1.h("div", { key: 'e55a96cfb6f5648a6388fa301b2379847389a66a', class: "plus-icon" }, index$1.h("img", { key: '670ffd7c815d412e03104e35a7a47e614da7736c', src: index$1.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index$1.h("div", { key: '5c3c4822b4d8500c6527df394a8dfe097792c243', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index$1.h("div", { class: "product-wrapper" }, index$1.h("div", { class: "product-wrapper-pivot" }, index$1.h("div", { class: "checkbox-wrapper" }, index$1.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index$1.h("product-card", { inline: true, product: productCard, paymentOptions: productCard.paymentOptions })), productCard.selectVariations && (index$1.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index$1.h("div", { key: 'a2be41750ca174b9efccaea6e4072aa8ee656d16', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index$1.h("button", { key: '887cefe57bb720b493e11a78a7f0c8b9b81da5dd', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const FrontImage = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '4255eb4aec16539af72395d482f9ab7c9c03ae5d' }, index$1.h("figure", { key: '9b93a19c07d096c221ec88551f765e0616c7f0ad', class: this.getImageClassByProps() }, index$1.h("img", { key: 'df29dad7df8ad63bb511d618c3bb5029f46f089a', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish() }), !!this.figCaption && index$1.h("figcaption", { key: 'fc72c85e55768d046d6a1e145345a45f52c5ed43' }, this.figCaption))));
    }
    static get watchers() { return {
...
const FrontSelect = class {
    ...
    componentWillLoad() {
        document.documentElement.style.setProperty('--arrow-up-image-src', `url(${index$1.getAssetPath('../../../assets/images/arrow-up.png')})`);
    }
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: '9c28e7df16d8486f95f60fae619c9100a00dc4ae' }, this.label && (index$1.h("label", { key: '8a98185e686648c4be3c991a56b7ea6d80c40c2c', class: "select-label", htmlFor: this.selectId }, this.label)), index$1.h("div", { key: 'b89103e2f0c67bc364359076401992c9b1d60c29', class: "front-select-container" }, index$1.h("select", { key: '71fd70b929ee8c097f9e2af9d6718a45d7ca9106', name: this.selectName, id: this.selectId }, index$1.h("option", { key: '39f6512bff6ea7384577572f01354875dce707ec', disabled: this.placeholder.disabled, value: this.placeholder.value, selected: this.value === this.placeholder.value }, this.placeholder.name), (_a = this.optionsList) === null || _a === void 0 ? void 0 :
            _a.map(({ name, value, disabled }) => (index$1.h("option", { value: value, selected: this.value === value, disabled: disabled }, name)))))));
    }
};
...
const ProductCard = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index$1.h(index$1.Host, { key: 'c2849f1f71c31e8988f179311c08f17ddb3abefc' }, index$1.h("div", { key: 'ebf9f0f7f4a465cc26aa56f4f5d30f0d8ef65cf9', class: this.getClassWithInline('product-container') }, index$1.h("front-image", { key: '7af72f9305a7812f06c473ea9ffe4c8d676d84e3', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index$1.h("div", { key: '7696f7c41e351128f258e1a5f813221847a4a0c4', class: "info" }, index$1.h("span", { key: 'd755574e1486ec77ab2c508d7b6a90657fcfea2f', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index$1.h("product-price", { key: '2374846921c3158924b248f917d82e38793e751a', basePrice: this.basePrice, paymentOptions: this.paymentOptions })))));
    }
};
...
const ProductPrice = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.componentMap = {
            simple: (option) => (index$1.h("product-price-simple", { price: option.price, priceCompare: option.priceCompare })),
            billet: (option) => (index$1.h("product-price-billet", { price: option.price, priceCompare: option.priceCompare })),
            creditCard: (option) => (index$1.h("product-price-credit-card", { price: option.price, priceCompare: option.priceCompare, parcels: option.parcels, parcelPrice: option.parcelPrice, hasInterest: option.hasInterest })),
            pix: (option) => (index$1.h("product-price-pix", { price: option.price, priceCompare: option.priceCompare })),
        };
        this.basePrice = undefined;
    ...
    render() {
        ...
        if (!options.length) {
            return (index$1.h(index$1.Host, null, index$1.h("div", { class: "product-price-container" }, this.componentMap.simple({
                type: 'simple',
                price: this.basePrice.price,
                priceCompare: this.basePrice.priceCompare,
            }))));
        }
        return (index$1.h(index$1.Host, null, index$1.h("div", { class: "product-price-container" }, options.map(option => this.renderPaymentOption(option)))));
    }
};
...
const ProductPriceBillet = class {
    ...
    render() {
        ...
        return (index$1.h("div", { key: '7e4f59d482cd44d2c2141be0de16f7912df04121', class: "payment-option payment-option-billet" }, formattedCompare && index$1.h("span", { key: 'a029bec9efeaf46fdc3f94dbdb6f5559587001b8', class: "price-compare" }, formattedCompare), index$1.h("span", { key: 'a642eefada8171c903cd345e7d11999c7932f889', class: "price-current" }, index$1.h("span", { key: 'e02f7ada59c4d70762dfda819f636881d73c92b5', class: "highlight" }, formattedPrice), " no boleto")));
    }
};
...
const ProductPriceCreditCard = class {
    ...
    render() {
        ...
        return (index$1.h("div", { key: 'fcaf98a966d4b303278f56286c3e02328bf594ef', class: "payment-option payment-option-creditCard" }, formattedCompare && index$1.h("span", { key: '801b7a20846ff20e86b34c84ce09cc7a4959400c', class: "price-compare" }, formattedCompare), index$1.h("span", { key: '1983277e72b9298a1204235437d400d0d6827dcc', class: "price-current" }, index$1.h("span", { key: 'b7303f78a5054b62e1935abac75b2fb27a030e73', class: "highlight" }, formattedPrice), ' ', this.parcels && this.parcelPrice && (index$1.h("span", { key: '622941089d0a1443a59f643f9e16a273115fcac6', class: "credit-info" }, "em at\u00E9 ", index$1.h("span", { key: '5f329b94d862f3261ce190208e115789227d035c', class: "highlight" }, this.parcels, "x"), " de", ' ', index$1.h("span", { key: '822204a9a1b67f47d00735aa7707288695ef80b4', class: "highlight" }, formattedParcelPrice), " ", interestText)))));
    }
};
...
const ProductPricePix = class {
    ...
    render() {
        const formattedPrice = currencyFormat(this.price);
        const formattedCompare = this.priceCompare ? currencyFormat(this.priceCompare) : null;
        return (index$1.h("div", { key: 'aa777209ae9b6ef0d346636e72987e008c55cef5', class: "payment-option payment-option-pix" }, formattedCompare && index$1.h("span", { key: '70d9b9afea53d6216ef40bbb335c7efb42a80e81', class: "price-compare" }, formattedCompare), index$1.h("span", { key: '8edb40c47a82587aeef1d7a6d0e9f50127703310', class: "price-current" }, index$1.h("span", { key: 'e57adef29cef013e19cb64538a0e214db2d19ea7', class: "highlight" }, formattedPrice), " no pix")));
    }
};
...
const ProductPriceSimple = class {
    ...
    render() {
        const formattedPrice = currencyFormat(this.price);
        const formattedCompare = this.priceCompare ? currencyFormat(this.priceCompare) : null;
        return (index$1.h("div", { key: 'a07bb826dd643b57a5e338dbe4c10570530e6326', class: "payment-option payment-option-simple" }, formattedCompare && index$1.h("span", { key: '7d893a78f48cc35b0761f0332c006995f384b52f', class: "price-compare" }, formattedCompare), index$1.h("span", { key: '44d023e1ed50598c8ba89b4206dc5621dfcf5d45', class: "price-current" }, index$1.h("span", { key: '269f9d3a9643ed80fa697c28a50c8e20d1e27e3e', class: "highlight" }, formattedPrice))));
    }
};
...
const showcaseCss = ".splide__container{box-sizing:border-box;position:relative}.splide__list{backface-visibility:hidden;display:-ms-flexbox;display:flex;height:100%;margin:0!important;padding:0!important}.splide.is-initialized:not(.is-active) .splide__list{display:block}.splide__pagination{-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:center;justify-content:center;margin:0;pointer-events:none}.splide__pagination li{display:inline-block;line-height:1;list-style-type:none;margin:0;pointer-events:auto}.splide:not(.is-overflow) .splide__pagination{display:none}.splide__progress__bar{width:0}.splide{position:relative;visibility:hidden}.splide.is-initialized,.splide.is-rendered{visibility:visible}.splide__slide{backface-visibility:hidden;box-sizing:border-box;-ms-flex-negative:0;flex-shrink:0;list-style-type:none!important;margin:0;position:relative}.splide__slide img{vertical-align:bottom}.splide__spinner{animation:splide-loading 1s linear infinite;border:2px solid #999;border-left-color:transparent;border-radius:50%;bottom:0;contain:strict;display:inline-block;height:20px;left:0;margin:auto;position:absolute;right:0;top:0;width:20px}.splide__sr{clip:rect(0 0 0 0);border:0;height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}.splide__toggle.is-active .splide__toggle__play,.splide__toggle__pause{display:none}.splide__toggle.is-active .splide__toggle__pause{display:inline}.splide__track{overflow:hidden;position:relative;z-index:0}@keyframes splide-loading{0%{transform:rotate(0)}to{transform:rotate(1turn)}}.splide__track--draggable{-webkit-touch-callout:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.splide__track--fade>.splide__list>.splide__slide{margin:0!important;opacity:0;z-index:0}.splide__track--fade>.splide__list>.splide__slide.is-active{opacity:1;z-index:1}.splide--rtl{direction:rtl}.splide__track--ttb>.splide__list{display:block}.splide__arrow{-ms-flex-align:center;align-items:center;background:#ccc;border:0;border-radius:50%;cursor:pointer;display:-ms-flexbox;display:flex;height:2em;-ms-flex-pack:center;justify-content:center;opacity:.7;padding:0;position:absolute;top:50%;transform:translateY(-50%);width:2em;z-index:1}.splide__arrow svg{fill:#000;height:1.2em;width:1.2em}.splide__arrow:hover:not(:disabled){opacity:.9}.splide__arrow:disabled{opacity:.3}.splide__arrow:focus-visible{outline:3px solid #0bf;outline-offset:3px}.splide__arrow--prev{left:1em}.splide__arrow--prev svg{transform:scaleX(-1)}.splide__arrow--next{right:1em}.splide.is-focus-in .splide__arrow:focus{outline:3px solid #0bf;outline-offset:3px}.splide__pagination{bottom:.5em;left:0;padding:0 1em;position:absolute;right:0;z-index:1}.splide__pagination__page{background:#ccc;border:0;border-radius:50%;display:inline-block;height:8px;margin:3px;opacity:.7;padding:0;position:relative;transition:transform .2s linear;width:8px}.splide__pagination__page.is-active{background:#fff;transform:scale(1.4);z-index:1}.splide__pagination__page:hover{cursor:pointer;opacity:.9}.splide__pagination__page:focus-visible{outline:3px solid #0bf;outline-offset:3px}.splide.is-focus-in .splide__pagination__page:focus{outline:3px solid #0bf;outline-offset:3px}.splide__progress__bar{background:#ccc;height:3px}.splide__slide{-webkit-tap-highlight-color:rgba(0,0,0,0)}.splide__slide:focus{outline:0}@supports (outline-offset:-3px){.splide__slide:focus-visible{outline:3px solid #0bf;outline-offset:-3px}}@media screen and (-ms-high-contrast:none){.splide__slide:focus-visible{border:3px solid #0bf}}@supports (outline-offset:-3px){.splide.is-focus-in .splide__slide:focus{outline:3px solid #0bf;outline-offset:-3px}}@media screen and (-ms-high-contrast:none){.splide.is-focus-in .splide__slide:focus{border:3px solid #0bf}.splide.is-focus-in .splide__track>.splide__list>.splide__slide:focus{border-color:#0bf}}.splide__toggle{cursor:pointer}.splide__toggle:focus-visible{outline:3px solid #0bf;outline-offset:3px}.splide.is-focus-in .splide__toggle:focus{outline:3px solid #0bf;outline-offset:3px}.splide__track--nav>.splide__list>.splide__slide{border:3px solid transparent;cursor:pointer}.splide__track--nav>.splide__list>.splide__slide.is-active{border:3px solid #000}.splide__arrows--rtl .splide__arrow--prev{left:auto;right:1em}.splide__arrows--rtl .splide__arrow--prev svg{transform:scaleX(1)}.splide__arrows--rtl .splide__arrow--next{left:1em;right:auto}.splide__arrows--rtl .splide__arrow--next svg{transform:scaleX(-1)}.splide__arrows--ttb .splide__arrow{left:50%;transform:translate(-50%)}.splide__arrows--ttb .splide__arrow--prev{top:1em}.splide__arrows--ttb .splide__arrow--prev svg{transform:rotate(-90deg)}.splide__arrows--ttb .splide__arrow--next{bottom:1em;top:auto}.splide__arrows--ttb .splide__arrow--next svg{transform:rotate(90deg)}.splide__pagination--ttb{bottom:0;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;left:auto;padding:1em 0;right:.5em;top:0}.splide__track--nav>.splide__list>.splide__slide{border:3px solid transparent;border-radius:4px;cursor:pointer;opacity:.7}.splide__track--nav>.splide__list>.splide__slide.is-active{border:3px solid #20b2aa;opacity:1}.splide__arrows--ttb .splide__arrow{left:50%;transform:translate(-50%)}.splide__arrows--ttb .splide__arrow--prev{top:1em}.splide__arrows--ttb .splide__arrow--prev svg{transform:rotate(-90deg)}.splide__arrows--ttb .splide__arrow--next{bottom:1em;top:auto}.splide__arrows--ttb .splide__arrow--next svg{transform:rotate(90deg)}.splide__pagination--ttb{bottom:0;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;left:auto;padding:1em 0;right:1em;top:0}.splide__pagination--ttb .splide__pagination__page{height:20px;width:5px}.splide__arrow{-ms-flex-align:center;align-items:center;background:transparent;border:0;border-radius:0;cursor:pointer;display:-ms-flexbox;display:flex;height:2.5em;-ms-flex-pack:center;justify-content:center;padding:0;position:absolute;top:50%;transform:translateY(-50%);width:2.5em;z-index:1}.splide__arrow svg{fill:#000;height:2.5em;transition:fill .2s linear;width:2.5em}.splide__arrow:hover:not(:disabled) svg{opacity:0.75}.splide__arrow:disabled{opacity:.3}.splide__arrow:focus-visible{outline:3px solid #20b2aa;outline-offset:3px}.splide__arrow--prev{left:1em}.splide__arrow--prev svg{transform:scaleX(-1)}.splide__arrow--next{right:1em}.splide.is-focus-in .splide__arrow:focus{outline:3px solid #20b2aa;outline-offset:3px}.splide__pagination{bottom:1em;left:0;padding:0 1em;position:absolute;right:0;z-index:1}.splide__pagination__page{background:#ccc;border:0;border-radius:2.5px;display:inline-block;height:5px;margin:3px;padding:0;position:relative;transition:background-color .2s linear;width:20px}.splide__pagination__page.is-active{background:#20b2aa;z-index:1}.splide__pagination__page:hover{background:#57e1d9;cursor:pointer;opacity:.9}.splide__pagination__page:focus-visible{outline:3px solid #20b2aa;outline-offset:3px}.splide.is-focus-in .splide__pagination__page:focus{outline:3px solid #20b2aa;outline-offset:3px}.splide__slide{-webkit-tap-highlight-color:rgba(0,0,0,0);border-radius:4px}.splide__slide:focus{outline:0}@supports (outline-offset:-3px){.splide__slide:focus-visible{outline:3px solid #20b2aa;outline-offset:-3px}}@media screen and (-ms-high-contrast:none){.splide__slide:focus-visible{border:3px solid #20b2aa}}@supports (outline-offset:-3px){.splide.is-focus-in .splide__slide:focus{outline:3px solid #20b2aa;outline-offset:-3px}}@media screen and (-ms-high-contrast:none){.splide.is-focus-in .splide__slide:focus{border:3px solid #20b2aa}.splide.is-focus-in .splide__track>.splide__list>.splide__slide:focus{border-color:#20b2aa}}.splide__container{box-sizing:border-box;position:relative}.splide__list{backface-visibility:hidden;display:-ms-flexbox;display:flex;height:100%;margin:0!important;padding:0!important}.splide.is-initialized:not(.is-active) .splide__list{display:block}.splide__pagination{-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:center;justify-content:center;margin:0;pointer-events:none}.splide__pagination li{display:inline-block;line-height:1;list-style-type:none;margin:0;pointer-events:auto}.splide:not(.is-overflow) .splide__pagination{display:none}.splide__progress__bar{width:0}.splide{position:relative;visibility:hidden}.splide.is-initialized,.splide.is-rendered{visibility:visible}.splide__slide{backface-visibility:hidden;box-sizing:border-box;-ms-flex-negative:0;flex-shrink:0;list-style-type:none!important;margin:0;position:relative}.splide__slide img{vertical-align:bottom}.splide__spinner{animation:splide-loading 1s linear infinite;border:2px solid #20b2aa;border-left-color:transparent;border-radius:50%;bottom:0;contain:strict;display:inline-block;height:20px;left:0;margin:auto;position:absolute;right:0;top:0;width:20px}.splide__sr{clip:rect(0 0 0 0);border:0;height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px}.splide__toggle.is-active .splide__toggle__play,.splide__toggle__pause{display:none}.splide__toggle.is-active .splide__toggle__pause{display:inline}.splide__track{overflow:hidden;position:relative;z-index:0}@keyframes splide-loading{0%{transform:rotate(0)}to{transform:rotate(1turn)}}.splide__track--draggable{-webkit-touch-callout:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.splide__track--fade>.splide__list>.splide__slide{margin:0!important;opacity:0;z-index:0}.splide__track--fade>.splide__list>.splide__slide.is-active{opacity:1;z-index:1}.splide--rtl{direction:rtl}.splide__track--ttb>.splide__list{display:block}.splide__progress__bar{background:#ccc;height:3px}.splide__toggle{cursor:pointer}.splide__toggle:focus-visible{outline:3px solid #20b2aa;outline-offset:3px}.splide.is-focus-in .splide__toggle:focus{outline:3px solid #20b2aa;outline-offset:3px}.splide__arrows--rtl .splide__arrow--prev{left:auto;right:1em}.splide__arrows--rtl .splide__arrow--prev svg{transform:scaleX(1)}.splide__arrows--rtl .splide__arrow--next{left:1em;right:auto}.splide__arrows--rtl .splide__arrow--next svg{transform:scaleX(-1)}.splide__slider>.splide__arrows .splide__arrow--prev{left:-2.5em}.splide__slider>.splide__arrows .splide__arrow--next{right:-2.5em}.splide{padding:3em}*{--fc-font-family:var(--m-ff);--fc-border-radius:4px;--fc-color-primary:var(--color-primary, #ff4295);--fc-color-secondary:var(--color-secondary, #000);--fc-color-white:var(--white, #fff);--fc-m-tt:var(--m-tt, \"uppercase\");--fc-m-fs:var(--m-fs, 14px);--fc-m-fw:var(--m-fw, 600);--fc-m-ls:var(--m-ls, 1px);--fc-h2-fs:var(--h2-fs, 18px);--fc-h2-fw:var(--h2-fw, 600);--fc-h2-ls:var(--h2-ls, 0px);--fc-color-light-text-default:#343a40;--fc-color-light-text-secondary:#6d747a;--fc-color-light-border-default:#dee2e6;--fc-gap-grid:24px;--fc-margin-width:8px}@keyframes lds-dual-ring-animation{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}.splide__arrow--next{right:0.5em}.splide__arrow--prev{left:0.5em}ul li:not(:last-child){margin-bottom:0 !important}.loading-container{display:flex;width:100%;justify-content:center;align-items:center;min-height:350px}.loading-container .spinner{--spinner-color:var(--fc-color-secondary, #000);display:inline-block;width:80px;height:80px}.loading-container .spinner:after{content:\" \";display:block;width:64px;height:64px;margin:8px;border-radius:50%;border:6px solid var(--spinner-color);border-color:var(--spinner-color) transparent var(--spinner-color) transparent;animation:lds-dual-ring-animation 1.2s linear infinite}.showcase-related-products-title{text-align:center;margin:0}.product-form{height:100%}.product-main-container{height:100%;display:flex;flex-direction:column;justify-content:space-between;gap:24px;max-height:650px;padding:16px;border:1px solid #dee2e6;border-radius:8px}.product-main-container .product-container>.image{max-width:250px;max-height:250px}.buy-button{--btn-bg-color:var(--fc-color-primary);--btn-text-color:var(--fc-color-white);--btn-text-weight:var(--fc-m-fw, 600);--btn-text-size:var(--fc-m-fs);--btn-text-transform:var(--fc-m-tt, \"uppercase\");--btn-text-letter-spacing:var(--fc-m-ls, 1px);all:unset;box-sizing:border-box;width:100%;background-color:var(--btn-bg-color);color:var(--btn-text-color);font-weight:var(--btn-text-weight);font-size:var(--btn-text-size);padding:12px 24px;cursor:pointer;border-radius:var(--fc-border-radius);text-align:center;text-transform:var(--btn-text-transform);letter-spacing:var(--btn-text-letter-spacing);--btn-bg-color:var(--color-buy-button);--btn-text-color:var(--color-buy-button-text);background-color:var(--primary);color:var(--fc-color-white, #fff)}.buy-button:hover{opacity:0.75}.buy-button:disabled{opacity:0.6;cursor:not-allowed}@media (min-width: 768px){.splide-container{display:flex;justify-content:center}}";
const ShowcaseRelatedStyle0 = showcaseCss;

const Showcase = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.clickBuyButton = index$1.createEvent(this, "clickBuyButton", 7);
    ...
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: 'b505083682d6bb37458fa4685e99788c286f2be5' }, this.loading && (index$1.h("div", { key: '4531c3907441992a9da36387eca59007c6630923', class: "loading-container" }, index$1.h("span", { key: 'ca70993f6eca0dc87c2d1fde4e660d6a751474e1', class: "spinner" }))), !this.loading && this.products.length ? (index$1.h("div", { class: "showcase-related-products" }, index$1.h("h4", { class: "showcase-related-products-title" }, this.showcaseTitle || 'Recomendados para você'), index$1.h("div", { class: "splide-container" }, index$1.h("div", { id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, index$1.h("div", { class: "splide__track" }, index$1.h("ul", { class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
            return (index$1.h("li", { class: "splide__slide" }, index$1.h("form", { class: "product-form", onSubmit: evt => this.onClickBuyButtonEmit(evt, product) }, index$1.h("div", { class: "product-main-container" }, index$1.h("product-card", { product: product, paymentOptions: product.paymentOptions }), index$1.h("button", { type: "submit", class: "buy-button" }, this.buttonLabel || 'Comprar')))));
...
const VariationSelector = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.inputSelect = index$1.createEvent(this, "inputSelect", 7);
    ...
    render() {
        return (index$1.h("div", { key: '26b357ac76edf33861876ad88f2c5045e6b29fcf', class: `variations ${this.showcaseMode ? '-showcase' : ''}` }, this.variations.map(({ label, currentValue, options, selectId, placeholder, selectType }) => (index$1.h("div", { class: "item" }, index$1.h("front-select", { placeholder: placeholder, selectId: selectId, optionsList: options, label: label, value: currentValue, onInput: data => this.onInputSelect(data, selectType) }))))));
    }
};
...
exports.showcase_related = Showcase;
exports.variation_selector = VariationSelector;

//# sourceMappingURL=buy-together_11.cjs.entry.js.map