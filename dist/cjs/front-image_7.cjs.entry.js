...
const FrontImage = class {
    ...
    render() {
        return (index.h(index.Host, { key: '57ae7b5a53ed80f0cdb9e571518d50f5dec2101e' }, index.h("figure", { key: '1200242fe131f56e799ce9fc0c9eadecf7348a1b', class: this.getImageClassByProps() }, index.h("img", { key: '42bd880cd3333c5a6ce88039fac4a2d582b72d0a', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish() }), !!this.figCaption && index.h("figcaption", { key: '30ec70f8334e0f200ab94edd77ea18ffd98c23a8' }, this.figCaption))));
    }
...
const ProductCard = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '0c4ad2a7762896b056747a149a2ce59fc5d15b35' }, index.h("div", { key: '849efaded16f137d360a4962206e518572cb74be', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: '6dc99b8115c654a6ba94d447c4484aeeb7cc2adc', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: 'ec60a6fe203c8ccaf3b310e99dd62133fab3165d', class: "info" }, index.h("span", { key: '18f9fa95d434d2620df7ee0cca65b2dc7a78c89d', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("product-price", { key: '5a27e86ec858c67f83edb72244faf1c22dc37e12', basePrice: this.basePrice, paymentOptions: this.paymentOptions, showStartingFrom: this.showStartingFrom }), index.h("div", { key: '0e6056904820387dc40cc1300e5891b94e9f20f6', class: "product-card-content" }, index.h("slot", { key: '39c8180d5ae125093aa2f879be426fdf0805410c' }))))));
    }
};
...
const ProductPriceBillet = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd444f38cce6a4d93990a0fb7f504031a5ae41d9d', class: "payment-option payment-option-billet" }, formattedCompare && index.h("span", { key: 'd5a8d7034f2a06abdae96987747fafedcbf3dbba', class: "price-compare" }, formattedCompare), index.h("span", { key: '71cb31b0778cdf99526910fd70217ea0301016a6', class: "price-current" }, index.h("span", { key: '4db2215e6be2e31b6b7cbd505d165675c7f399f8', class: "highlight" }, formattedPrice), " no boleto")));
    }
};
...
const ProductPriceCreditCard = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '56a875663ecd813875e362cdea7769ed23236d8d', class: "payment-option payment-option-creditCard" }, formattedCompare && index.h("span", { key: 'ddd49c016c2b181db4173ec9c2c6ab6f787404f8', class: "price-compare" }, formattedCompare), index.h("span", { key: '9719e2a84fbe76a78f5be522cf1e98789e584fd2', class: "price-current" }, index.h("span", { key: 'f3a05883142a48722ad8974c0f36b0c014e43732', class: "highlight" }, formattedPrice), ' ', this.parcels && this.parcelPrice && (index.h("span", { key: '83b2e831989ce156cc973d0e1972c3ffac3b6bb7', class: "credit-info" }, "em at\u00E9 ", index.h("span", { key: 'a4dddd1c63c11c4490b881469535d012a59f40e0', class: "highlight" }, this.parcels, "x"), " de", ' ', index.h("span", { key: '1009009ef0873a920cc38a0aceed666523acc2a7', class: "highlight" }, formattedParcelPrice), " ", interestText)))));
    }
};
...
const ProductPricePix = class {
    ...
    render() {
        const formattedPrice = utils.currencyFormat(this.price);
        const formattedCompare = this.priceCompare ? utils.currencyFormat(this.priceCompare) : null;
        return (index.h("div", { key: 'fbbfc3f1dad8ed61bcfa78dd2c5fb143a86ec947', class: "payment-option payment-option-pix" }, formattedCompare && index.h("span", { key: 'a2a3db3ecffd83354591f02fbc4b59c594782dea', class: "price-compare" }, formattedCompare), index.h("span", { key: '3a045f8a0ef3b448badb502be616e8ef44479848', class: "price-current" }, index.h("span", { key: 'e9320d8b853026a0c3ae01e8593a7bf6f41a0b30', class: "highlight" }, formattedPrice), " no pix")));
    }
};
...
const ProductPriceSimple = class {
    ...
    render() {
        const formattedPrice = utils.currencyFormat(this.price);
        const formattedCompare = this.priceCompare ? utils.currencyFormat(this.priceCompare) : null;
        return (index.h("div", { key: '3da59e42467e4d3a56658f52453854640b302708', class: "payment-option payment-option-simple" }, this.showStartingFrom && index.h("span", { key: '7635df5662b5126422ac34326d689eb5d94d88b3', class: "starting-from" }, "A partir de"), formattedCompare && !this.showStartingFrom && (index.h("span", { key: 'f34c1035e12fd97e5fd7d7521ccd253ded27a0b8', class: "price-compare" }, formattedCompare)), index.h("span", { key: 'f973fd9504873ce2390600909c87e6bbce0ecf13', class: "price-current" }, index.h("span", { key: 'd12bcce1bdc465fdd4b4c7f83011696a1cc733c1', class: "highlight" }, formattedPrice))));
    }
};
