...
const index$1 = require('./index-5ea523e2.js');
...
const CustomCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bf02f44cdc6c2da39b0529867a67262758a764bb' }, index.h("div", { key: '4a0472e9cccced2e7888ceb716280eb424821b27', class: `custom-card ${this.customClass}` }, index.h("div", { key: 'ffeb567152895df9085959ac4a6fc2bb6588cb90', class: "custom-card-header" }, index.h("h2", { key: '976d0f0d92f4d6c6e8a77c4622324e762c383cd3', class: "custom-card-header-title" }, this.cardTitle), this.cardDescription && (index.h("p", { key: '17396eac2ca965b1d33a390f372d1a7086735f47', class: "custom-card-header-description" }, this.cardDescription))), index.h("div", { key: '1c55813bd7d4d66b04d06794606a38be5d3a1d76', class: "custom-card-content" }, index.h("slot", { key: 'a0b7326af7ae7b1346e37fb1d2b1ce90bca1d076' })))));
    }
};
...
const HighlightCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1bec2619adbb46bcb6ca24333a54eed64e164189' }, index.h("div", { key: '2131db9a08f0be0905c0cbe2fb2ea0309d75741e', class: "highlight-card" }, this.highlightedItems.length > 0 && (index.h("div", { key: '2293dbd85cd2b9295295d86491c8564ede506590', class: "highlight-card-container" }, index.h("div", { key: '57058ccfde1a9d6ac6d20ad55ba4b3c545592ffe', class: "highlight-card-header" }, index.h("span", { key: 'd85ada76ac9cd891a62411635aac8e1dd4c5f5ae', class: "highlight-card-header-title" }, "Destaque")), this.highlightedItems.map((item, index$1) => (index.h("div", null, this.renderItem(item, true), index$1 < this.highlightedItems.length - 1 && (index.h("div", { class: "highlight-card-separator" }))))))), this.nonHighlightedItems.map(item => this.renderItem(item, false)))));
    }
    static get watchers() { return {
...
const LiveShopDesktop = class {
    ...
    render() {
        return (index.h("div", { key: '83688007127152e35d37fa214d5d757dc09bd8dc', class: "live-shop-in-live-desktop" }, index.h("div", { key: '8590bcd8113204cfeb05cf04d082751e6fdde378', class: "live-shop-in-live-desktop-infos" }, index.h("div", { key: 'c56a9f3355bf340c5a88138743c0d840897c8ea7', class: "live-shop-in-live-desktop-infos-player" }, index.h("live-video-player", { key: '836ced4d3feaa823d795a610d7cb9883e51cb823', videoId: this.videoId, autoPlay: true })), index.h("div", { key: '830a5186917f5ce1545ada8aacbc7d4f5fad2e9a', class: "live-shop-in-live-desktop-infos-options" }, index.h("h2", { key: '2c83f90c525e1804751ef7ebeb41584d8a07901e', class: "live-shop-in-live-desktop-infos-options-title" }, this.liveShopData.name), this.liveShopData.chatVisible && (index.h("button", { key: '82ca6cdd8047dfd3648fcdedf93f9f44fddfae7e', class: "live-shop-in-live-desktop-infos-options-button", onClick: this.toggleChat }, this.buttonText()))), this.isChatOpen && (index.h("div", { key: 'faef8dce8b2e7e59bd0ede6ee089ff8b3e846893', class: "live-shop-in-live-desktop-infos-options-chat" }, index.h("live-video-chat", { key: 'a6ac796d0b3be7d74a0b15b5bb65681337b7b8a3', videoId: this.videoId })))), index.h("div", { key: 'd168ffd8d0765d10abc8036abab2d68652944f70', class: "live-shop-in-live-desktop-content" }, index.h("div", { key: '5c16659d233eafe133c5e619a628f084431b5146', class: "live-shop-in-live-desktop-content-card" }, this.items.length > 0 && this.items.some(item => item.show) ? (index.h("highlight-card", { items: this.items, onAddItem: this.handleAddItem })) : (index.h("custom-card", { customClass: "in-live-custom-style-desktop", cardTitle: "produtos a caminho...", cardDescription: "Em breve, teremos algo especial para voc\u00EA!" }))))));
    }
};
...
const LiveShopMobile = class {
    ...
    render() {
        return (index.h("div", { key: '3bd015899f2bc4fa515693fd7eac3421c8da8595', class: "live-shop-in-live" }, index.h("div", { key: 'b35e861c895705ae0f4fe5089aed4db265c8fd63', class: "live-shop-in-live-player" }, index.h("live-video-player", { key: 'de3b46504d7ebfff2d8c5c346e3cbe1f5afe86c1', videoId: this.videoId, autoPlay: true })), index.h("div", { key: 'ce7b8980f954d1a5acdb0a5ddae6991f0af52e81', class: "live-shop-in-live-options" }, index.h("custom-card", { key: 'bb0c62f474bc778fc917fbd93ddd5ed1fc4de668', customClass: "in-live-custom-style", cardTitle: this.liveShopData.name }, index.h("tab-selector", { key: '6025af2ee9e65ac7cd0c9fdec8229f458f54029d', tabs: tabs(this.videoId, this.items, this.handleAddItem, this.liveShopData.chatVisible) })))));
    }
};
...
const LiveShopNotFound = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1f403b5b2af650c1b722d1334e01a520f29c51ac' }, index.h("div", { key: 'bd76a6b90162f5a8afb6ba6d8ef777e5b3a4c324', class: "live-shop-not-found" }, index.h("custom-card", { key: 'de9bc6b31df20b18db73e6472ea325a4ffec2e8e', cardTitle: "Ops, parece que essa live n\u00E3o existe mais!", cardDescription: "Fique de olho em nossas pr\u00F3ximas lives para mais novidades e promo\u00E7\u00F5es imperd\u00EDveis!" }, index.h("button", { key: '992492e601ac1025b555ec7a4cc828f0003e96bd', onClick: this.handleReturnToHome }, "Voltar para a p\u00E1gina inicial")))));
    }
};
