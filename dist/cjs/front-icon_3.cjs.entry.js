...
const MiniPlayer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c3b95cb5b3be2656e01e196be960058974be0490' }, this.showMiniPlayer && (index.h("div", { key: '336ad2762077302a5507da061caf97d522216e0f', class: "mini-player", style: this.getMiniPlayerStyle() }, index.h("button", { key: '0811e694f9bfdad71cb5d8b44f1f0f36b4813b7c', class: "mini-player-close-button", onClick: () => this.handleCloseMiniPlayer() }, index.h("front-icon", { key: '8c640d22818fcd17d2aa362ba7702333f5109cfd', name: "close" })), index.h("live-video-player", { key: '76bdfe51a47e209a9476eb1441dee8356b2d2ef3', videoId: this.videoId, autoPlay: this.autoPlay }), index.h("div", { key: '4c0f0d190b479125c25f53175a8cab76f6f1bc6c', class: "mini-player-bar", style: this.getMiniPlayerBarStyle(), onMouseDown: this.handleDragStart, onTouchStart: event => this.handleTouchStart(event) }, index.h("h6", { key: 'b228f613a2673f3afbb28ee71cd007240d860844', class: "mini-player-bar-title" }, this.mainTitle), index.h("div", { key: '16bcb7e5d29098db646b3624fb214baf207676af', class: "mini-player-bar-button" }, index.h("button", { key: '1c4644478b4d2ffd648e1899fe8cda4392aa0396', onClick: () => this.onClickMiniPlayerButton.emit() }, this.buttonText)))))));
    }
};
