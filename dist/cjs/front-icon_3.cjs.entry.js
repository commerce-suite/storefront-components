...
const FrontIcon = class {
    ...
    render() {
        return (index.h("span", { key: '9a708e95c57f1570dddea5da8965fb03c357cda7', class: "material-icons", style: { color: this.color, fontSize: this.size } }, this.name));
    }
};
...
const LiveVideoPlayer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9e8bb0ce71256d899bfb2914707adab8f070ee33' }, index.h("div", { key: '311dc8c8a179054b069457d057aa271004a70957', class: "live-video-player" }, index.h("iframe", { key: '56e3314f4fc2936d7c73916767406d2df5481f73', src: this.getVideoUrl(), frameborder: "0", allow: "accelerometer; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true }))));
    }
};
...
const MiniPlayer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '072e86a2e70052fa044395f1e3dd42ac748ec796' }, this.showMiniPlayer && (index.h("div", { key: 'd030604176a278317e1c73445bd1e95dd2774d0f', class: "mini-player", style: this.getMiniPlayerStyle() }, index.h("button", { key: '42d7421c947c8e459309d9cb79aabf4ac4c7f945', class: "mini-player-close-button", onClick: () => this.handleCloseMiniPlayer() }, index.h("front-icon", { key: 'cd1fa7bb5657c38f050a028e5e3fd028d9388863', name: "close" })), index.h("live-video-player", { key: 'fa957bdb1ad9d56b29c534a05393179d98a87ec9', videoId: this.videoId, autoPlay: this.autoPlay }), index.h("div", { key: 'cf79d1259ca938181061edfb1ae07a317a3b14ca', class: "mini-player-bar", style: this.getMiniPlayerBarStyle(), onMouseDown: this.handleDragStart, onTouchStart: event => this.handleTouchStart(event) }, index.h("h6", { key: '3f0c05a388704b7d120751854ff6fee579f8374e', class: "mini-player-bar-title" }, this.mainTitle), index.h("div", { key: '87df5d602e24a94948b0f8bc15b6bc139de2754f', class: "mini-player-bar-button" }, index.h("button", { key: '5e27c4ad44416195b054183eed073a3e668233c6', onClick: () => this.onClickMiniPlayerButton.emit() }, this.buttonText)))))));
    }
};
...
//# sourceMappingURL=front-icon_3.cjs.entry.js.map