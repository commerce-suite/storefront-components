...
const MiniPlayer = class {
    constructor(hostRef) {
        ...
        this.onClickButton = index.createEvent(this, "on-click-button", 7);
    ...
    render() {
        return (index.h(index.Host, { key: 'c4c405775853ebbba9b5976ca94ee22823646772' }, this.showMiniPlayer && (index.h("div", { key: '039b0accc787250a0cf7b6904a8eeb2fbe7d600a', class: "mini-player", style: this.getMiniPlayerStyle() }, index.h("button", { key: '209d26ea8883ab81303de40d609c52db0c0ff916', class: "mini-player-close-button", onClick: () => this.handleCloseMiniPlayer() }, index.h("img", { key: 'b5bd05674c660d729fb163dce53d42b945467c8b', src: index.getAssetPath('./assets/icons/close-icon.svg'), alt: "close-icon" })), index.h("live-video-player", { key: '06fe503027cd79fa3f89f7029b74e168778e249d', videoId: this.videoId, autoPlay: this.autoPlay }), index.h("div", { key: 'bd8ab99ad4ee9de31c3548984de84207a2faadd5', class: "mini-player-bar", style: this.getMiniPlayerBarStyle(), onMouseDown: this.handleDragStart, onTouchStart: this.handleDragStart }, index.h("h6", { key: 'd83f9a01936a283073dde0d9099e9cfe703def4a', class: "mini-player-bar-title" }, this.mainTitle), index.h("div", { key: '789fc5d38005852c4fa53ece15c05372ad7e9955', class: "mini-player-bar-button" }, index.h("button", { key: '724f7e6b196f8d14882764b3f308bfa6939b652c', onClick: () => this.onClickButton.emit() }, this.buttonText)))))));
    }
};
