...
const MiniPlayer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'afcd293d0b82abbb8076063bf7fe0ea15b6c1381' }, this.showMiniPlayer && (index.h("div", { key: '51e3f3c27c66fb4bc79107b8a18d7b717cda6588', class: "mini-player", style: this.getMiniPlayerStyle() }, index.h("button", { key: 'cac3d98b9ce61ee82235ff65f78c5a264e16f8c0', class: "mini-player-close-button", onClick: () => this.handleCloseMiniPlayer() }, index.h("img", { key: '8e630cd5ae6ee41697ceabe09cc426a256b072cb', src: index.getAssetPath('./assets/icons/close-icon.svg'), alt: "close-icon" })), index.h("live-video-player", { key: '643f7dab642799a394e0dcd280c31951f0cb9813', videoId: this.videoId, autoPlay: this.autoPlay }), index.h("div", { key: 'f718201f59c97cad5fdf45523b92e99986bebbde', class: "mini-player-bar", style: this.getMiniPlayerBarStyle(), onMouseDown: this.handleDragStart, onTouchStart: event => this.handleTouchStart(event) }, index.h("h6", { key: '67f99bbb642e81d0aa83ea2429ee15b3ce4c10c3', class: "mini-player-bar-title" }, this.mainTitle), index.h("div", { key: '08393ccd6bffca59fbd49bee410bf1b8cea98e25', class: "mini-player-bar-button" }, index.h("button", { key: 'f166a052f7bdb6cb8018ccf6f20c9327890c43dd', onClick: () => this.onClickMiniPlayerButton.emit() }, this.buttonText)))))));
    }
};
