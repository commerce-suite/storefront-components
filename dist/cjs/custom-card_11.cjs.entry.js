...
const ProductCard = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'e13ad1193d530d9a79f9397107012c7d5a1132b2' }, index.h("div", { key: '89973da4d163b9fab6ba25dcab34e44043587b2a', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: 'f0ef2820bd49b0caea40f943f0694bb4207fa07a', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: '49551011110ab50c99f2591b3999fb19cbc5a406', class: "info" }, index.h("span", { key: '1db9b300008cb5560f92f8d2b159895b8dada89e', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("div", { key: '1609936379062330d5cdff50667f92bbc0255971', class: "price" }, this.showPriceBase && (index.h("span", { key: 'a36c4e3938c1f09ca8e520882fea8da23a79e08d', class: "base" }, currencyFormat(this.product.priceBase))), index.h("span", { key: 'be2acde1e0f7115e4a62cb9e22a8aea867fcdc5b', class: "current" }, this.getPrice()))))));
    }
};
...
const TabSelector = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '402fff36355422c22ed5e5da12a4b6a5f1d1bb93', class: "tab-selector" }, index.h("div", { key: 'bfdcb4e2163f3cb76761ff61cf91317e1e17c573', class: "tab-selector-tabs" }, (_a = this.tabs) === null || _a === void 0 ? void 0 : _a.map(tab => (index.h("span", { class: { active: this.activeTab === tab.name }, onClick: () => this.handleTabClick(tab.name) }, tab.label)))), index.h("div", { key: '909183d885cf8cb409654ccbefbb65c320e594b9', class: "tab-selector-tabs-content" }, (_b = this.tabs) === null || _b === void 0 ? void 0 : _b.map(tab => (index.h("div", { class: {
...
//# sourceMappingURL=custom-card_11.cjs.entry.js.map