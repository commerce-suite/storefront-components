...
const InfoModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c656971e7e4972e5cb0648500d627978014697d' }, index.h("div", { key: '7c4e6623f9cce27d2da9e720c40f6655a26edc5f', class: `info-modal ${this.getModalPosition()} ${this.hideButtons ? '-hide-buttons' : ''}` }, index.h("div", { key: '099f32650c49a7b1402952e4a8465155dc86f818', class: "info-modal-header" }, index.h("h2", { key: '3aeade608cf44037b8ad4aff01daf5a9075085aa', class: "info-modal-header-title" }, this.modalTitle), index.h("p", { key: '84a0feb211a0af41fc69863fa0fa986d770e981d', class: "info-modal-header-description" }, this.modalDescription)), !this.hideButtons && (index.h("div", { key: 'fb2b270164591d2d07ab5970f4c5b2433f554ebd', class: "info-modal-buttons" }, index.h("button", { key: 'bf794d41f664e55010af638c6999f712eded3876', class: "info-modal-buttons-primary", onClick: () => this.onClickPrimaryButton.emit() }, this.primaryButtonText), index.h("button", { key: '31729d24a7346e89ca6c16feffe0b8ef52f7c5fe', class: "info-modal-buttons-secondary", onClick: () => this.onClickSecondaryButton.emit() }, this.secondaryButtonText))))));
    }
};
