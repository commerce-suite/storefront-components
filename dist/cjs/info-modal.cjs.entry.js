...
const InfoModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6a2b2fe73845b78e0d02defa6c532468a6a10d3d' }, index.h("div", { key: 'c6c842531421e52c4bf2ba762b98a42ab6c46201', class: `info-modal ${this.getModalPosition()} ${this.hideButtons ? '-hide-buttons' : ''}` }, index.h("div", { key: '5097af2b8dfbc751cad64b1e0d9c623292fbe3b7', class: "info-modal-header" }, index.h("h2", { key: '99a01b5dad12dd69e102b31c244d121a110dcf2c', class: "info-modal-header-title" }, this.modalTitle), index.h("p", { key: 'd5ce2161c70e1233938f72467365b57486c78b32', class: "info-modal-header-description" }, this.modalDescription)), !this.hideButtons && (index.h("div", { key: '0ba2e89c1d99ea3cd9e7acde478b4023d8c2d818', class: "info-modal-buttons" }, index.h("button", { key: 'c327651261f593781253f942413a052680111ff4', class: "info-modal-buttons-primary", onClick: () => this.onClickPrimaryButton.emit() }, this.primaryButtonText), index.h("button", { key: '887f2e49752d1f966e276ed4f052aa9948443d0a', class: "info-modal-buttons-secondary", onClick: () => this.onClickSecondaryButton.emit() }, this.secondaryButtonText))))));
    }
};
