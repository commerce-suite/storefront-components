...
const InfoModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7d720100debd5d0f878dab2f522598b69658fc54' }, index.h("div", { key: '3409a10062518538148aba763beebdcdf397e9d9', class: `info-modal ${this.getModalPosition()} ${this.hideButtons ? '-hide-buttons' : ''}` }, index.h("div", { key: 'bb7118c13582a92bc58e9d195c2a0f463168688e', class: "info-modal-header" }, index.h("h2", { key: 'a5f836ee048bd17023bed9974e492b71863ed1b2', class: "info-modal-header-title" }, this.modalTitle), index.h("p", { key: '90c235fef9a4c20b70c154051591176765330a44', class: "info-modal-header-description" }, this.modalDescription)), !this.hideButtons && (index.h("div", { key: '5f441f4949b80f38d8fb6d4f561fe833530b4820', class: "info-modal-buttons" }, index.h("button", { key: 'ee70e11002235ecfa9ecc673068be02134ed1db5', class: "info-modal-buttons-primary", onClick: () => this.onClickPrimaryButton.emit() }, this.primaryButtonText), index.h("button", { key: '1e1f30a462517922b3985f1c92f3c4373a3dab3e', class: "info-modal-buttons-secondary", onClick: () => this.onClickSecondaryButton.emit() }, this.secondaryButtonText))))));
    }
};
