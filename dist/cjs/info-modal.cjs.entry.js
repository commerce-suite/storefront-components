...
const InfoModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '792ba0e8da80f4bff032309ed2867bd362dd44b9' }, index.h("div", { key: '022b2ef6aed138f9c8fe9566ee3f416596ddfb32', class: `info-modal ${this.getModalPosition()} ${this.hideButtons ? '-hide-buttons' : ''}` }, index.h("div", { key: 'a56dbdf56b6635dddfb7dfd10a6d0fe30309ec55', class: "info-modal-header" }, index.h("h2", { key: '9a88109404295aa68a2e815fbfa00be310505b40', class: "info-modal-header-title" }, this.modalTitle), index.h("p", { key: '91269d8c8177eb0308b301de7c082e3c740b318e', class: "info-modal-header-description" }, this.modalDescription)), !this.hideButtons && (index.h("div", { key: 'f7c1b9b7ea48607c4fbceb87d37447b795c0bbca', class: "info-modal-buttons" }, index.h("button", { key: '3bc9d2b145f835bfe0978e7e12f25830fd679599', class: "info-modal-buttons-primary", onClick: () => this.onClickPrimaryButton.emit() }, this.primaryButtonText), index.h("button", { key: '6a4ca0dbac4a71d76c63370ec8a746b9c6f90280', class: "info-modal-buttons-secondary", onClick: () => this.onClickSecondaryButton.emit() }, this.secondaryButtonText))))));
    }
};
InfoModal.style = infoModalCss;
