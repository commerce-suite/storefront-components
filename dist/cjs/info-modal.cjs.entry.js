...
const InfoModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '23841cc018170b92babb8dbeedd9f7d5c85a0698' }, index.h("div", { key: 'c2b3c4acb6c7912f773cc4edd7783f8f6161a6f7', class: `info-modal ${this.getModalPosition()} ${this.hideButtons ? '-hide-buttons' : ''}` }, index.h("div", { key: 'ff6e1f1b95dc7ef7263fbf77c7fe5ff79dda519a', class: "info-modal-header" }, index.h("h2", { key: 'e919652d59ebc67d798286c42625f10405264777', class: "info-modal-header-title" }, this.modalTitle), index.h("p", { key: '21c284dd63f66ebff7d22e181006f6db5a73a1f9', class: "info-modal-header-description" }, this.modalDescription)), !this.hideButtons && (index.h("div", { key: 'd997b13ede7d8db1a7f39d34f1918e4ad5787c46', class: "info-modal-buttons" }, index.h("button", { key: 'fd33a8a4e9f79b1f5c67e55dc943509f375b2df8', class: "info-modal-buttons-primary", onClick: () => this.onClickPrimaryButton.emit() }, this.primaryButtonText), index.h("button", { key: 'ba32abe4c7583d0ea0e581515fb779358339b74f', class: "info-modal-buttons-secondary", onClick: () => this.onClickSecondaryButton.emit() }, this.secondaryButtonText))))));
    }
};
