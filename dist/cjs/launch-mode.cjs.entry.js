...
const index$1 = require('./index-ed1a22c2.js');
const index = require('./index-0d53d433.js');
...
const LaunchMode = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '2f04a58e9fb49d4dbb306af1148566b8e3b3c635', style: {
                '--launch-title': colorTitle,
                '--launch-caption': colorCaption,
                '--launch-button-bg': colorButton,
            } }, (this.isLoading || this.isInitialLoading) && (index$1.h("div", { key: '3f03f5d6002aba433b587ee5c59abe589a859801', class: `loading-container ${this.isInitialLoading ? '-initial-loading' : ''}` }, index$1.h("span", { key: '5be69b1fa720d4be7ae4bcbf5dbb2c925749ac89', class: "spinner" }))), this.launchModeData && !this.isInitialLoading && (index$1.h("div", { key: '8ffb73b0c2520f33398f21ebb2755bf98c75e3ce', class: "launch-mode launch-mode-container" }, index$1.h("div", { key: 'bceb9b44133fd32e7f429c8ed56b6eb61b6e66eb', class: "launch-mode-content" }, index$1.h("div", { key: '4f9cdd39df8dcb2b9c117106f628ae43acfb3aae', class: "launch-mode-content-label" }, index$1.h("h1", { key: '98b874c80e97fa15c2dcb6f1b5c5a7efede53ba7', class: "h1" }, title), index$1.h("div", { key: '1e2a9be6ff7533bc5753d12c72297dadf51ab9a2', innerHTML: caption })), index$1.h("form", { key: 'e10a93ce0ee8410cea3bd9a3e6cebe629d23a51b', onSubmit: e => this.handleSubmit(e), class: "launch-mode-form" }, index$1.h("div", { key: '3508f0f1ab12e16a0e8bbc0862219d8aa378eea1', class: "launch-mode-form-content" }, index$1.h("div", { key: '7417cdaccaa971eb74c6309f164e13d3cb891845', class: "launch-mode-form-content-input" }, index$1.h("input", { key: 'ded7bf21b3a727726b5896bcad72299d44e0374e', name: "password", type: this.showPassword ? 'text' : 'password', placeholder: "Digite sua senha", value: this.passwordInput, onInput: e => this.handlePasswordChange(e), required: true }), index$1.h("button", { key: 'eaf238e32518befa3b246eac112e22fb33611935', type: "button", class: "password-toggle-btn", onClick: () => this.togglePasswordVisibility(), "aria-label": this.showPassword ? 'Ocultar senha' : 'Mostrar senha' }, index$1.h("img", { key: '4bb356059a474e91a8f5a2e8e1abb46883d47b6f', src: index$1.getAssetPath(this.showPassword
                ? './assets/icons/eye-off.svg'
                : './assets/icons/eye.svg'), alt: this.showPassword ? 'Ocultar senha' : 'Mostrar senha' }))), index$1.h("button", { key: '0b4836a64079181bd82832c1e15023ccf91a274c', class: "launch-mode-form-content-button", type: "submit", disabled: this.isLoading || !this.passwordInput.trim() }, this.isLoading ? 'Destravando...' : 'Destravar'))), this.userMessage && (index$1.h("div", { key: 'c072e9c8682adf7aec7b2b0e9b402497c9ec991e', class: `launch-mode-content-message launch-mode-content-message-${this.userMessage.type}` }, index$1.h("span", { key: '722dd31a47c42767477eaac01c303e61a45a0662' }, this.userMessage.text))))))));
    }
};
