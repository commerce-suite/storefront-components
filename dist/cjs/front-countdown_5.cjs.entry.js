...
const MiniPlayer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40b0da23e02621611ff3d7d149cf48446ae1297d' }, this.showMiniPlayer && (index.h("div", { key: '5d4f43dea7c9c312531a426cbf3a29fe69916539', class: "mini-player", style: this.getMiniPlayerStyle() }, index.h("button", { key: '18f495ecdc874c9d2432336b03a15cd778d22d1f', class: "mini-player-close-button", onClick: () => this.handleCloseMiniPlayer() }, index.h("front-icon", { key: '122c131530981259432f438d95c19a113c94813a', name: "close" })), index.h("live-video-player", { key: 'e9b7697b07a6ceb0bd43e9958b0200b08d65234f', videoId: this.videoId, autoPlay: this.autoPlay }), index.h("div", { key: '709515a64b48cf99f1a64df2ea066a75e290c090', class: "mini-player-bar", style: this.getMiniPlayerBarStyle(), onMouseDown: this.handleDragStart, onTouchStart: event => this.handleTouchStart(event) }, index.h("h6", { key: '90d862415babe716a2416a92595033c4baff691a', class: "mini-player-bar-title" }, this.mainTitle), index.h("div", { key: 'f2c03994b6ad055d412d6764351a73b3c6c4bd9a', class: "mini-player-bar-button" }, index.h("button", { key: 'f2b7dbe660aab6e6c44e5c074a3e487bf701038d', onClick: () => this.onClickMiniPlayerButton.emit() }, this.buttonText)))))));
    }
};
...
//# sourceMappingURL=front-countdown_5.cjs.entry.js.map