...
const BuyTogether = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'aa7a2853a237d1db09b78a32ca832a46472f6de7' }, this.isLoading && (index.h("div", { key: '473a6c004081b218ed3d5390d61b62ce6b032117', class: "loading-container" }, index.h("span", { key: '65938546005b0fd6f5be88a4f7716bfaede900da', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index.h("form", { key: '29213e411c2f6b4908ce34501dcfb5152426d274', onSubmit: evt => this.onAddItemsToCart(evt) }, index.h("div", { key: '6b6253536effe07d2d7e5a54b0394d3a894d9b7e', class: "title-wrapper" }, index.h("h2", { key: 'fb2881cb4d53842d65cd3a03374cd9ba0deb9af1', class: "title" }, this.promotionTitle || 'Compre Junto')), index.h("section", { key: 'bbc12b2787105792c2cd291d04a91c66d0fbaa63', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index.h("div", { key: 'a7229d99bdfd38bb2c2070e37eac58576f666167', class: "product-main" }, index.h("div", { key: '6e97884eb80a51b8d089f4ff6deddab24c3b8b4d', class: "product-wrapper" }, index.h("product-card", { key: '9b01fc626d254959e996b30d905812c3afe8231c', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index.h("variation-selector", { key: 'd35303c6ccfc2b9b89d129b91196b3989cd86c88', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index.h("div", { key: '283d7974c147a70beb87f0461ef273fb781463ed', class: "plus-icon" }, index.h("img", { key: '10977259f0dbab3acf0f5672d8039705aa9f7b5d', src: index.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index.h("div", { key: 'd557fbe6d06bfe2cb6667939150ad289289ba2a7', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index.h("div", { class: "product-wrapper" }, index.h("div", { class: "product-wrapper-pivot" }, index.h("div", { class: "checkbox-wrapper" }, index.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index.h("div", { key: '7c3ce76d99633818bc02c974940b4bf32ac11451', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index.h("button", { key: 'c887320e3b3d105ebdb52aa7ee14fc75714e592e', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const ProductCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eff28a07e749991e4da15dcc83011f39ff7248a8' }, index.h("div", { key: 'eda472f712bb5c07ce63854b0d991ff8863156c2', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: 'a032d4029195102c9969f5ea389e983168ba83e2', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: '3c56d54ba801596588a171808aca6d2e172b8741', class: "info" }, index.h("span", { key: 'd75c29e6f3b7589fc7fd3b9afcda83b628a4d89e', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("div", { key: '139612215b6083a9ba18a4108e61e4c32a45923a', class: "price" }, this.showPriceBase && (index.h("span", { key: '13b6e747cef66c10637ad79e2b884a770763598b', class: "base" }, currencyFormat(this.product.priceBase))), index.h("span", { key: '6941dea9b7a75c18f50750dd05d46b784cfaf94c', class: "current" }, currencyFormat((_f = this.product) === null || _f === void 0 ? void 0 : _f.price)))))));
    }
};
