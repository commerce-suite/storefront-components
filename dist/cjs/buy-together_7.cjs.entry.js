...
const BuyTogether = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '57766c0376fb05e0a0cfc8f26df9523936561127' }, this.isLoading && (index$1.h("div", { key: 'c59b571ec5a505a1d07d01e3b82fd28b22982045', class: "loading-container" }, index$1.h("span", { key: '83aeb352cc002a6f319d286086a4bb71db726bfe', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index$1.h("form", { key: 'd4fce1bf45cf01a1b44c18346f045b8d9a252c58', onSubmit: evt => this.onAddItemsToCart(evt) }, index$1.h("div", { key: '3de00cda8142435d453071344ec3202bb97418f6', class: "title-wrapper" }, index$1.h("h2", { key: '2eeb41e7f7f03f7fb20305ab2da5c160178c9d4a', class: "title" }, this.promotionTitle || 'Compre Junto')), index$1.h("section", { key: '4be8ebdb8203ac124690ef28aa0dd3b0ff55684b', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index$1.h("div", { key: '6e3fe94079bf0fada469b2d5509395c503906bd9', class: "product-main" }, index$1.h("div", { key: '117ad4aa6d370ea7a7390208218961c250c99aeb', class: "product-wrapper" }, index$1.h("product-card", { key: '7afa39cbd3ba1d0fd3ff9db90bef534d1dacf25c', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index$1.h("variation-selector", { key: '3a0a7ce957433b21fb390b82f0585097bc89468b', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index$1.h("div", { key: '5267f3c3a9fa5b4d4b79a6af48c081ed5d10605d', class: "plus-icon" }, index$1.h("img", { key: 'd392fe6f9535862d4b7694382823fbc1591ef77a', src: index$1.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index$1.h("div", { key: '061fe3ea7c85e4d37e3e12df4d7a122f834d95e2', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index$1.h("div", { class: "product-wrapper" }, index$1.h("div", { class: "product-wrapper-pivot" }, index$1.h("div", { class: "checkbox-wrapper" }, index$1.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index$1.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index$1.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index$1.h("div", { key: '4c488ad413bf8b15197adcbe6cf16dc00720bfd6', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index$1.h("button", { key: 'a4cea3a5ecb9a228ea88098a42cb7f196f60de29', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyButtonText || 'Comprar')))))));
    }
...
const buyTogetherCartModalCss = "*{--fc-font-family:var(--m-ff);--fc-border-radius:4px;--fc-color-primary:var(--color-primary, #ff4295);--fc-color-secondary:var(--color-secondary, #000);--fc-color-white:var(--white, #fff);--fc-m-tt:var(--m-tt, \"uppercase\");--fc-m-fs:var(--m-fs, 14px);--fc-m-fw:var(--m-fw, 600);--fc-m-ls:var(--m-ls, 1px);--fc-h2-fs:var(--h2-fs, 18px);--fc-h2-fw:var(--h2-fw, 600);--fc-h2-ls:var(--h2-ls, 0px);--fc-color-light-text-default:#343a40;--fc-color-light-text-secondary:#6d747a;--fc-color-light-border-default:#dee2e6;--fc-gap-grid:24px;--fc-margin-width:8px}.buy-together-cart{display:flex;flex-direction:column;gap:24px}.buy-together-cart-header{display:flex;flex-direction:column;justify-content:space-between;align-items:center;gap:8px}.buy-together-cart-header-text{display:flex;flex-direction:column;align-items:center;gap:8px}@media (min-width: 1024px){.buy-together-cart-header-text{flex-direction:row}}.buy-together-cart-header-text img{width:32px;height:32px}.buy-together-cart-header-text h2{margin:0}@media (min-width: 1024px){.buy-together-cart-header{flex-direction:row}}.header-buttons{display:flex;flex-direction:column;gap:8px}@media (min-width: 1024px){.header-buttons{flex-direction:row}}.header-buttons-primary{--btn-bg-color:var(--fc-color-primary);--btn-text-color:var(--fc-color-white);--btn-text-weight:var(--fc-m-fw, 600);--btn-text-size:var(--fc-m-fs);--btn-text-transform:var(--fc-m-tt, \"uppercase\");--btn-text-letter-spacing:var(--fc-m-ls, 1px);all:unset;box-sizing:border-box;width:100%;background-color:var(--btn-bg-color);color:var(--btn-text-color);font-weight:var(--btn-text-weight);font-size:var(--btn-text-size);padding:12px 24px;cursor:pointer;border-radius:var(--fc-border-radius);text-align:center;text-transform:var(--btn-text-transform);letter-spacing:var(--btn-text-letter-spacing);background-color:var(--color-buy-button)}.header-buttons-primary:hover{opacity:0.75}.header-buttons-primary:disabled{opacity:0.6;cursor:not-allowed}.header-buttons-secondary{--btn-bg-color:var(--fc-color-primary);--btn-text-color:var(--fc-color-white);--btn-text-weight:var(--fc-m-fw, 600);--btn-text-size:var(--fc-m-fs);--btn-text-transform:var(--fc-m-tt, \"uppercase\");--btn-text-letter-spacing:var(--fc-m-ls, 1px);all:unset;box-sizing:border-box;width:100%;background-color:var(--btn-bg-color);color:var(--btn-text-color);font-weight:var(--btn-text-weight);font-size:var(--btn-text-size);padding:12px 24px;cursor:pointer;border-radius:var(--fc-border-radius);text-align:center;text-transform:var(--btn-text-transform);letter-spacing:var(--btn-text-letter-spacing);white-space:nowrap}.header-buttons-secondary:hover{opacity:0.75}.header-buttons-secondary:disabled{opacity:0.6;cursor:not-allowed}";
const BuyTogetherCartModalStyle0 = buyTogetherCartModalCss;

const BuyTogetherCartModal = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.onFinishBuyButton = index$1.createEvent(this, "on-finish-buy-button", 7);
        this.onContinueBuyButton = index$1.createEvent(this, "on-continue-buy-button", 7);
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '42b8ba68d240a13d3672c0a1eefcc489c7e83186' }, index$1.h("section", { key: '8e6dfc0458c20bbd22b988e74ab7cec49d40caaf', class: "buy-together-cart" }, index$1.h("header", { key: 'dbd476cc9ef3264811bfdb4c7864a486567e03cd', class: "buy-together-cart-header" }, index$1.h("div", { key: '038d56447b6ac92fbdc7f0dda822e0932dca40f9', class: "buy-together-cart-header-text" }, index$1.h("img", { key: 'd072b0db1a067af9c507f6183d26527193218e77', src: index$1.getAssetPath('./assets/icons/add.svg'), alt: "add_icon" }), index$1.h("h2", { key: '81f92c1031bf03e8e15419e4d05ad54048931b47' }, this.containerTitle || 'Produto adicionado ao carrinho!')), index$1.h("div", { key: '545358bab6c8f644cfbaee939450f7b792029d49', class: "header-buttons" }, index$1.h("button", { key: 'c6403db810524069bc2645284c0b741f1050342b', onClick: () => this.onFinishBuyButton.emit(), class: "header-buttons-primary" }, "Finalizar compra"), index$1.h("button", { key: '535c90890b070d09d8d99504405ff288a364fea4', onClick: () => this.onContinueBuyButton.emit(), class: "header-buttons-secondary" }, "Continuar comprando"))), index$1.h("buy-together", { key: '509b323047d790395cfd49d1e0cf6be7a1407124', id: "buy-together", "promotion-title": this.promotionTitle, "buy-button-text": this.buyButtonText, "product-id": this.productId, "variation-id": this.variationId, "showcase-mode": true }))));
    }
};
BuyTogetherCartModal.style = BuyTogetherCartModalStyle0;
...
const FrontImage = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '02f31a7d523ad529da5221f97fadc4b16e5d3b5e' }, index$1.h("figure", { key: '45cde14b0a9eedc571d6f6d759a10ea4ee9d0c8f', class: this.getImageClassByProps() }, index$1.h("img", { key: '196981269af260a6d30fd90c4ddb7b88af552c62', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish() }), !!this.figCaption && index$1.h("figcaption", { key: '3c101926b00fee2462142ed2de0e59df3a214d95' }, this.figCaption))));
    }
    static get watchers() { return {
...
const FrontSelect = class {
    ...
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: 'ffe66918b2aa73adacdc637b25b41a83c35688af' }, this.label && (index$1.h("label", { key: '7e118d1f212caef5c0bf4c502b6905a25d8876ab', class: "select-label", htmlFor: this.selectId }, this.label)), index$1.h("div", { key: '1daae45e7ae7175dbaf6a47f1ea4ab47d4dbf9a3', class: "front-select-container" }, index$1.h("select", { key: '90f8c13c9191c52d5703e428702493612e76a210', name: this.selectName, id: this.selectId }, index$1.h("option", { key: '6a5d0078fa374f59bb417449064dac9db91aeef5', disabled: this.placeholder.disabled, value: this.placeholder.value, selected: this.value === this.placeholder.value }, this.placeholder.name), (_a = this.optionsList) === null || _a === void 0 ? void 0 :
...
const ProductCard = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'eff28a07e749991e4da15dcc83011f39ff7248a8' }, index$1.h("div", { key: 'eda472f712bb5c07ce63854b0d991ff8863156c2', class: this.getClassWithInline('product-container') }, index$1.h("front-image", { key: 'a032d4029195102c9969f5ea389e983168ba83e2', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index$1.h("div", { key: '3c56d54ba801596588a171808aca6d2e172b8741', class: "info" }, index$1.h("span", { key: 'd75c29e6f3b7589fc7fd3b9afcda83b628a4d89e', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index$1.h("div", { key: '139612215b6083a9ba18a4108e61e4c32a45923a', class: "price" }, this.showPriceBase && (index$1.h("span", { key: '13b6e747cef66c10637ad79e2b884a770763598b', class: "base" }, currencyFormat(this.product.priceBase))), index$1.h("span", { key: '6941dea9b7a75c18f50750dd05d46b784cfaf94c', class: "current" }, currencyFormat((_f = this.product) === null || _f === void 0 ? void 0 : _f.price)))))));
    }
};
...
const Showcase = class {
    ...
    render() {
        var _a;
        return (index$1.h(index$1.Host, { key: '3337f758ffec76c3f09aab4501daba3238873252' }, this.loading && (index$1.h("div", { key: 'cefdc13a8b3d98a49a85c6480a933f6f84ddb13e', class: "loading-container" }, index$1.h("span", { key: 'a7fad4b3f33e0f27d276d467e0d54e78aaa7674e', class: "spinner" }))), !this.loading && this.products.length && (index$1.h("div", { key: '119f978dc72dde278cc77af0b5d11005ac269c0c', class: "showcase-related-products" }, index$1.h("h4", { key: 'cb0bada80a168a8e17506595ecdf2262b1da141e', class: "showcase-related-products-title" }, this.showcaseTitle), index$1.h("div", { key: '7a8cc85d7961fcc5808b9aaedd45e0c84b2d08bd', id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, index$1.h("div", { key: 'e6063e74b9856d899b6fdfe163e0ada18a842a5e', class: "splide__track" }, index$1.h("ul", { key: '638386034a29cc8cd1f6b7b6e481030ca2880980', class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
            return (index$1.h("li", { class: "splide__slide" }, index$1.h("form", { class: "product-form", onSubmit: evt => this.onClickBuyButtonEmit(evt, product) }, index$1.h("div", { class: "product-main-container" }, index$1.h("product-card", { product: product }), index$1.h("button", { type: "submit", class: "buy-button" }, "Comprar")))));
        }))))))));
    }
};
...
const VariationSelector = class {
    ...
    render() {
        return (index$1.h("div", { key: '94ac72ee36a0cdbab96ac09b606f9275d11822c8', class: `variations ${this.showcaseMode ? '-showcase' : ''}` }, this.variations.map(({ label, currentValue, options, selectId, placeholder, selectType }) => (index$1.h("div", { class: "item" }, index$1.h("front-select", { placeholder: placeholder, selectId: selectId, optionsList: options, label: label, value: currentValue, onInput: data => this.onInputSelect(data, selectType) }))))));
    }
};
VariationSelector.style = VariationSelectorStyle0;

exports.buy_together = BuyTogether;
exports.buy_together_cart_modal = BuyTogetherCartModal;
