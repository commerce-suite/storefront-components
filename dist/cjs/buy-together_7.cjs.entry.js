...
const BuyTogether = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0cd89a1cb4b53563e3c5a0d9d72e4017a03a2e64' }, this.isLoading && (index.h("div", { key: '3028bdb6fd11ed7b555025762692bad5cd717ea0', class: "loading-container" }, index.h("span", { key: '78c0bd38d64e684c1cb65139adb0f99f10244b04', class: "spinner" }))), !this.isLoading && this.hasBuyTogether && (index.h("form", { key: '03e16547cbee88b110102c8e2a035e4e15e3b966', onSubmit: evt => this.onAddItemsToCart(evt) }, index.h("div", { key: '04be75be85be01ff1f40552cb7055dd8d9d9aef5', class: "title-wrapper" }, index.h("h2", { key: 'a832dbf440e9c6cc19095bd6d8de981f2c214e45', class: "title" }, this.buyTogetherData.originalData.title || 'Compre Junto')), index.h("section", { key: '0ee545481c05e1133bb1bb5d836a1adfad91b52b', class: `bagy-buy-together buy-together-container ${this.showcaseModeClass()}` }, !this.showcaseMode && (index.h("div", { key: 'c2204ccb90b82eb71622970a03a1610e68e3695a', class: "product-main" }, index.h("div", { key: '85dbaefa729c50f7a82475aa797e50d909415c1f', class: "product-wrapper" }, index.h("product-card", { key: '496821bf6e13f1333a5d14d941e17bd5944889b8', product: this.buyTogetherData.productMain }), this.buyTogetherData.productMain.selectVariations && (index.h("variation-selector", { key: '425f7d3ff20ced4d020abf95700616fd1708fd60', productId: this.buyTogetherData.productMain.id, onInputSelect: ev => this.onInputSelectProductMain(ev), variations: this.buyTogetherData.productMain.selectVariations }))))), !this.showcaseMode && (index.h("div", { key: 'cdf8f5f9fa139b1037f4d59d4f13c4cfa0bf3207', class: "plus-icon" }, index.h("img", { key: '1bbbfbc8395aca8503f4305a25469fbfed08e790', src: index.getAssetPath('./assets/icons/icon-plus.svg'), alt: "" }))), index.h("div", { key: '7b92d837dee9089ec65a759ae0553576d4cff9e8', class: `products-order-bump ${this.showcaseModeClass()}` }, this.buyTogetherData.products.map(productCard => (index.h("div", { class: "product-wrapper" }, index.h("div", { class: "product-wrapper-pivot" }, index.h("div", { class: "checkbox-wrapper" }, index.h("input", { type: "checkbox", checked: productCard.isCheck, id: String(productCard.id), onInput: ev => this.selectOrderBump(ev, productCard.id) })), index.h("product-card", { inline: true, product: productCard })), productCard.selectVariations && (index.h("variation-selector", { productId: productCard.id, variations: productCard.selectVariations, onInputSelect: ev => this.onInputSelectOrderBump(ev), showcaseMode: this.showcaseMode })))))), index.h("div", { key: '342f206c1fbfbece08426a4f6caa497bba1a341c', class: `buy-btn-wrapper ${this.showcaseModeClass()}` }, index.h("button", { key: '7d6042af2514596d5a27173327dd0f6706439a1d', class: "buy-btn", type: "submit", disabled: this.isAddingToCart || !this.formIsValid }, this.buyTogetherData.originalData.buyButtonText || 'Comprar')))))));
    }
...
const FrontCountdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0e57cd02db0d613b4e071ef412693a87d2041aef', class: "timer" }, index.h("div", { key: '6698c019604f66c47b489a32784108dd6a443cd9', class: "cell" }, index.h("p", { key: 'a7d2b87a71a15630c748e553477d685f3314e9ad', class: "time" }, this.days), index.h("p", { key: '23c38397aa663d1aedc84c306cefc703dde92353', class: "unit" }, "dias")), index.h("div", { key: '55290bcb462b315089ca0d99821a2276f4ba7259', class: "cell" }, index.h("p", { key: 'ac7c2a1283499289642696ba845f8d2556dc6ed7', class: "time" }, this.hours), index.h("p", { key: '28cfa0a7cef6f1f06eec5062c56d0f73e7fb0c30', class: "unit" }, "horas")), index.h("div", { key: '9b8680fbac63d66c7940772a4d1b3e10253caae3', class: "cell" }, index.h("p", { key: '4389abac6b5c5ab10e439fea565b90e2d7d6cb40', class: "time" }, " ", this.minutes), index.h("p", { key: '914981949287eecd80933d502164bc7d9b4ddab8', class: "unit" }, "minutos")), index.h("div", { key: 'de6a718cbe240583cad21a53c3b4bb58174ad6a6', class: "cell" }, index.h("p", { key: '51b7e12a8fcdeb5a9bcc63bb587cb8e552d8b012', class: "time" }, this.seconds), index.h("p", { key: '6b139f2f10c64d5a7a483a444266db83d7730d90', class: "unit" }, "segundos"))));
    }
    static get watchers() { return {
...
const FrontImage = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0d7dec8afefd3f1b83a8f4bc699407988667ea3f' }, index.h("figure", { key: 'bf9cf2be0bcbb311dba4e8998d768bb668452626', class: this.getImageClassByProps() }, index.h("img", { key: '9c56ad826fbad2456fb35dc4a994213441bd9385', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish() }), !!this.figCaption && index.h("figcaption", { key: 'a88e477440272ec247638e0d8bebe30165f8977c' }, this.figCaption))));
    }
    static get watchers() { return {
...
const FrontSelect = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'f377ef9cc186891230be16f769dbb7a3fc277045' }, this.label && (index.h("label", { key: '34abf11094df21cc5e2a6a59e9eeecefa4c7ca2a', class: "select-label", htmlFor: this.selectId }, this.label)), index.h("div", { key: 'd5f7f8e50af04fe7d399b9314be5da70862796d6', class: "front-select-container" }, index.h("select", { key: '7e6ccb7f3d2286a4e21fc5229b3cafab110bd125', name: this.selectName, id: this.selectId }, index.h("option", { key: '48e1f35c8c97c49f11edf712e4cfa5b2fcae2705', disabled: this.placeholder.disabled, value: this.placeholder.value, selected: this.value === this.placeholder.value }, this.placeholder.name), (_a = this.optionsList) === null || _a === void 0 ? void 0 :
...
const LaunchCountdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '30a4a721f1fdf440408b0304a576b1ebe2ec4f70' }, index.h("div", { key: '045e7b50ce51272c74a367d94426732b247520bd', class: "launch-countdown-container" }, index.h("div", { key: 'a26c6eb50724f68ec48930ff91c281e7752d80e4', class: "launch-countdown-container-header" }, index.h("h3", { key: 'ad4bcffd6b02e363fe9466f94241cb82fc8d2f13', class: "launch-countdown-container-title" }, this.dataCountdownTitle), index.h("p", { key: '095ba5903827f93366175dfe4817f03b421b0387', class: "launch-countdown-container-description" }, this.dataDescription)), index.h("front-countdown", { key: 'be5fff8d11232b3b2c24eac5372b771b76b5a1cf', "start-date": this.dateTime.startDate, "end-date": this.dateTime.endDate }))));
    }
    static get watchers() { return {
        "variationId": ["watchVariationIdChange"],
        "productId": ["watchProductIdChange"]
...
const ProductCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3bf48464c79089527f486f316b19c8e19f1bbcea' }, index.h("div", { key: 'a3cfa9de0a68586978ff8cb04d2140ecfaa3be24', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: 'a3e74a6034eb32c858c34be5390724d895bf9d82', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: '5d04b49a7e3d74310d56b2528ca9475b919a1f44', class: "info" }, index.h("span", { key: '7a944adbf6bd2d8c7d5315d46c8d307bc434c3c0', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("div", { key: '14a77353836f8437c76627f1ef0bf7ee907376ca', class: "price" }, this.showPriceBase && (index.h("span", { key: '99a840c197078d24ad632043f39a43a3ea4b4940', class: "base" }, currencyFormat(this.product.priceBase))), index.h("span", { key: '3e78a45606b8d378c6dc0a29c11a75b18ec7add5', class: "current" }, currencyFormat((_f = this.product) === null || _f === void 0 ? void 0 : _f.price)))))));
    }
};
