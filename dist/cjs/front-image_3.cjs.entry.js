...
const FrontImage = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3ec6e7d2c2d3892d12ade3a8a1927dcd7acd3e23' }, index.h("figure", { key: '504d6c93eab3f0937f9c32c68457c5e34798da87', class: this.getImageClassByProps() }, index.h("img", { key: '3c68fe2c0d75d3848ad7385d49801d0934e65542', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish(), onError: () => this.onSrcLoadError() }), !!this.figCaption && index.h("figcaption", { key: '4c1116b5128356dd3f695602cfbde3699bc78ec6' }, this.figCaption))));
    }
...
const ProductCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1abfd3a7453a9c35487f3b1ec72b59f44c3276ac' }, index.h("div", { key: '661f629da702844fabd5db4cc4e36358ad947d62', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: '0cdfc90c3a4aea3cd17fcedc4cf97e3d6cf1143d', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: '9e1efd7e24778fa360bca64c884f4ae7eff44a6d', class: "info" }, index.h("span", { key: 'd1efc1806317fa182f8db72d7abfa37c2e971883', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("div", { key: 'e8c6540a7d3414aab05f734dfd9b8f42193c1cae', class: "price" }, this.showPriceBase && (index.h("span", { key: '7396ef3deea8beda3dd7ef20bd2bda5326d6f9e8', class: "base" }, currencyFormat(this.product.priceBase))), index.h("span", { key: '01cc47d4a1e5897f5a4cda103ec44000bc4bdb16', class: "current" }, currencyFormat((_f = this.product) === null || _f === void 0 ? void 0 : _f.price)))))));
    }
};
