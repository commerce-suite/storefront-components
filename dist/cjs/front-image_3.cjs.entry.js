...
const FrontImage = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dfe19929d1a4460c3a53ab8b21473d50f373f95d' }, index.h("figure", { key: '8ca7f5cbd4cea2630345855ab5134053b87bc0c0', class: this.getImageClassByProps() }, index.h("img", { key: '88b32865d26eec60da8d9c2ec49f48ee61750c36', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish() }), !!this.figCaption && index.h("figcaption", { key: 'b5e2e7ee79664becc8951d8a24e3e5e3ab751c81' }, this.figCaption))));
    }
