...
const frontBuyTogether_service = require('./front-buy-together.service-7808ad91.js');
...
const FrontImage = class {
    ...
    onSrcLoadError() {
        this.imageSrc = index.getAssetPath('./assets/images/image-fallback.png');
        setTimeout(() => {
    ...
    render() {
        return (index.h(index.Host, { key: 'daf3ac48a0253f7f196b478ed4a3a1d27fde5511' }, index.h("figure", { key: 'd8b8ebe533e94ad30136fa9b49c28cea904ff209', class: this.getImageClassByProps() }, index.h("img", { key: 'ef3d12c21715e533b52c183f2d3d8bdbe0495f5a', src: this.imageSrc, alt: this.textAlt || 'Imagem', onLoad: () => this.onSrcLoadFinish(), onError: () => this.onSrcLoadError() }), !!this.figCaption && index.h("figcaption", { key: '365eea8bfca39d16b589a7eca873316945edf187' }, this.figCaption))));
    }
...
const ProductCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95b54126b248e6ce5af82df6e955f3db2063cc41' }, index.h("div", { key: '39770b78ccc4954eaee8695cb57f4efdf251fa8c', class: this.getClassWithInline('product-container') }, index.h("front-image", { key: 'c9285f4b275a905c16c431f241594208309b7ed0', class: this.getClassWithInline('image'), imageSrc: (_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.src, textAlt: ((_d = (_c = this.product) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.alt) || 'Imagem do produto' }), index.h("div", { key: '9748bd8acbe27867db1962e18225c1e301bdcec6', class: "info" }, index.h("span", { key: '3d71d4325d497515f5c1712cd74e5a859ac7c444', class: "title" }, (_e = this.product) === null || _e === void 0 ? void 0 : _e.name), index.h("div", { key: 'f9112a546c7fe15b2a4fb7395cd1e8a34dda2905', class: "price" }, this.showPriceBase && (index.h("span", { key: 'cafd877f586fe4bc7cbfffb9caff3cd74ca0806a', class: "base" }, currencyFormat(this.product.priceBase))), index.h("span", { key: '3109732a0278cf1ce37c4bcc57c398039b26e123', class: "current" }, currencyFormat((_f = this.product) === null || _f === void 0 ? void 0 : _f.price)))))));
    }
};
...
const Showcase = class {
    ...
    async load() {
        var _a;
        try {
            this.products = await new frontBuyTogether_service.FrontBuyTogetherService().getOnlyPivotProducts(this.productIds);
        }
        catch (error) {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '874d85640961bffe3dc7c9f20f0dd8b6f0e450ba' }, index.h("div", { key: '794f2c1abcce9865743d4b3bf7d434cbf7f347d4', class: "showcase-related-products" }, index.h("h4", { key: '98eb61743cdc114a6d7126ecefa3e07b80321cf2', class: "showcase-related-products-title" }, this.showcaseTitle), index.h("div", { key: 'e0d0a20281e6e79075355b2fb16bc75858fd3ccd', id: "splide", class: "splide", style: !this.showArrows ? { padding: '30px 0' } : {} }, index.h("div", { key: '6085373868c1ae8f9e6fcc3b0fb8198b72620722', class: "splide__track" }, index.h("ul", { key: '30754f1595bf68483a560035ff0a7a03d120c3d3', class: "splide__list" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
...
//# sourceMappingURL=front-image_3.cjs.entry.js.map