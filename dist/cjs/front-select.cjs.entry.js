...
const FrontSelect = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '53fd1470ea185f823ed5150af12dac2498550802' }, this.label && (index.h("label", { key: '100cf6ad4a278b0494061d97ecad7f264b370b32', class: "select-label", htmlFor: this.selectId }, this.label)), index.h("div", { key: '639364168599a323341c68adbe0293e1eb927d5e', class: "front-select-container" }, index.h("select", { key: 'c75152996156f5f9d596c6e29d2d96c7dc8c099d', name: this.selectName, id: this.selectId }, index.h("option", { key: '8d758bd42a16051624a7c322a407237a7f4cd94b', disabled: this.placeholder.disabled, value: this.placeholder.value, selected: this.value === this.placeholder.value }, this.placeholder.name), (_a = this.optionsList) === null || _a === void 0 ? void 0 :
